...
If you are using an LDAP service and the [LDAP synchronizer](/ldap-synchronizer.html) to manage your user data, you can continue to do this and use CAS. The LDAP synchronizer user must be registered in CAS. 
...
[Bonita BPM REST API](/rest-api-overview.html)
