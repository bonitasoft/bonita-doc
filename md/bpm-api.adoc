...
+++<a id="activity-deploy">++++++</a>+++

==== Response object extension (deploy query parameter)

The `d` (deploy) used to link:rest-api-overview.md#extend-resource[extend response object] can be used with :
 ...
 ** f:
  ...
  *** rootCaseId
  *** last_update_date
  *** supervisor_id (only in Efficiency and Performance editions)
...
+++<a id="archived-activity-deploy">++++++</a>+++
 ...
 ** f:
  *** supervisor_id: retrieve the information the process manager associated to this id has access to (only in Efficiency and Performance edition)
...
+++<a id="retrieve-the-usertask-context">++++++</a>+++
...
+++<a id="archived-user-task-deploy">++++++</a>+++
...
+++<a id="retrieve-the-case-context">++++++</a>+++
...
+++<a id="start-a-process-using-an-instantiation-contract">++++++</a>+++
...
+++<a id="process-supervisor-deploy">++++++</a>+++
...
* *Method* +
`GET`
+++<a id="flownode-search-data-params">++++++</a>+++
* *Data Params* +
link:rest-api-overview.md#resource_search[Standard search parameters] are available. +
...
+++<a id="archived-flow-node-deploy">++++++</a>+++
