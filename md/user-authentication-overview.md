...
* [CAS single sign-on (SSO)](/single-sign-cas.md)
...
**Note:** If you [configure your Bonita BPM platform to use CAS](/single-sign-cas.md), the logical flow of authentication is the same as above. 
