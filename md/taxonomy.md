...
* [Application and Process Design](_application-and-process-design.md)
  * [Bonita overview](bonita-overview.md)
  ...
  * [Bonita Studio preferences](bonita-studio-preferences.md)
  * [Bonita Studio hints and tips](bonita-studio-hints-and-tips.md)
  ...
  * [Organization](_organization.md)
    ...
    * [Organization management in Bonita Studio](organization-management-in-bonita-studio.md)
    * [Custom User Information in Bonita Studio](custom-user-information-in-bonita-studio.md)
  ...
  * [Process testing](_process-testing.md)
    ...
    * [Run a process from Bonita Studio for testing](run-a-process-from-bonita-studio-for-testing.md)
...
* [Installation](_installation.md)
  * [Bonita installation overview](bonita-installation-overview.md)
  * [Bonita Studio installation](bonita-studio-installation.md)
  * [Basic Bonita Platform installation](_basic-bonita-platform-installation.md)
    ...
    * [Platform configuration](Bonita_platform_setup.md)
  ...
  * [Advanced Bonita Platform installation](_advanced-bonita-platform-installation.md)
    ...
    * [Bonita in a cluster](_bonita-in-a-cluster.md)
      * [Overview of Bonita in a cluster](overview-of-bonita-in-a-cluster.md)
  ...
  * [Migration](_migration.md)
    ...
    * [Migrate from an earlier version of Bonita](migrate-from-an-earlier-version-of-bonita.md)
...
* [Bonita Portal Administration](_bonita-portal-administration.md)
  * [Bonita Portal interface](_bonita-portal-interface.md)
    * [Bonita Portal overview](bonita-portal-interface-overview.md)
  ...
  * [Process maintenance](_process-maintenance.md)
    ...
    * [Pause and resume services](pause-and-resume-services.md)
    * [BDM Management in Bonita Portal](bdm-management-in-bonita-portal.md)
  ...
  * [Organization in Bonita Portal](_organization-in-bonita-portal.md)
    * [Organization in Bonita Portal overview](organization-in-bonita-portal-overview.md)
    * [Organization maintenance](_organization-maintenance.md)
      ...
      * [Custom User Information in Bonita Portal](custom-user-information-in-bonita-portal.md)
...
* [Development](_development.md)
  ...
  * [Engine API](_engine-api.md)
    ...
    * [Configure connection to Bonita Engine](configure-client-of-bonita-engine.md)
  ...
  * [Bonita Portal URLs](bonita-portal-urls.md)
