...
* [Installation](_installation.md)
  ...
  * [Advanced Bonita Platform installation](_advanced-bonita-platform-installation.md)
    ...
    * [Performance](_performance.md)
      ...
      * [Purging unnecessary archive data](purge-tool.md)
...
* [Bonita in Production](_bonita-portal-administration.md)
  * [Bonita User Interfaces](_bonita-portal-interface.md)
    ...
    * [User Interface for End-users](_ui-for-users.md)
      * [Bonita User Portal view](_user-portal.md)
        ...
        * [User case list](portal-user-case-list.md)
      ...
      * [Bonita User Application view](_user-application.md)
	    ...
	    * [User process list](user-process-list.md)
	    * [User case list](user-application-case-list.md)
        * [User task list](user-task-list.md)
	...
	* [License information](license-info.md)
      * [Bonita Administrator Application view](_admin-application.md)
        * [Bonita Administrator Application overview](admin-application-overview.md)
        * [Process Management](_process-maintenance.md)
          * [Monitoring](monitoring.md)
          * [Administrator process list](admin-application-process-list.md)
          * [Administrator case list](cases.md)
          * [Administrator task list](admin-application-task-list.md)
        * [Organization](_organization-in-bonita-portal.md)
          * [Organization Management](organization-in-admin-application.md)
          * [Install/export an organization](admin-application-install-export-orga.md)
	...
	* [BDM Management](bdm-management-in-bonita-bpm-portal.md)
        ...
        * [Applications](applications.md)
        * [License information](license-info.md)
      * [Process Manager Portal view](_process-manager-portal.md)
        * [Configure a Process Manager](configure-process-manager.md)
	* [Process Manager content](process-manager-content.md)
      * [Bonita Technical User Portal view](_technical-user-portal.md)
  ...
  * [Technical Monitoring](_monitoring.md)
    * [Technical Monitoring overview](runtime-monitoring.md)
