...
see the [Development overview](/development-overview.html).
...
You also need to [create a dedicated bonita.home](/configuring-bonita-home-for-a-client.html) for the LDAP Synchronizer.
...
technicalUser
This is the [username of the platform adminstrator](/first-steps-after-setup.html#reset_pw).
platformAdmin

technicalPassword
This is the [password of the platform adminstrator](/first-steps-after-setup.html#reset_pw).
platform
...
After installation, Check that the ["User" profile](/profiles-overview.html) is defined for the tenant. 
