...
A toolbar is embedded to the editor, use it to:  
 ...
 - **Deploy** this application File (i.e all the application descriptors contained in this application file) and the referenced resources (pages, layout..) in the portal. :warning: If your pages use Rest API Extensions, you have to deploy those API manually.  
...
:warning: You don't need to define your pages twice, a page defined in the Navigation table will be accessible in the whole Application, you don't have to re-define it as an orphan page.  
