# 4.5.5.7 Restore the default Look & Feel

Normally, the Look & Feel for Bonita BPM Portal and for process forms is [managed using Bonita BPM Portal](/managing-look-feel.html). However, it is also possible to restore the default Look & Feel using the Bonita BPM Engine API. 
