...
This howto applies to the legacy task list -Bonita BPM 6.0 to 6.5.x versions- as well as the xref:user-task-list.adoc[new task list - from Bonita BPM 7.3 and above].
====
