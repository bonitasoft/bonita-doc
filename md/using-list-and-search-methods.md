...
1. To configure word-based search, using [the setup tool](Bonita_platform_setup.md), 
...
2. For each object you be excluded from word-based search,  using [the setup tool](Bonita_platform_setup.md), 
