...
If you are using [business data](/define-and-deploy-the-bdm.html), you need two additional data sources, BusinessDataDS and NotManagedBizDataDS.
...
8. Create [users with the standard profile](/manage-a-user.html).
...
If you use an LDAP or Active Directory system, you can use the [LDAP synchronizer](/ldap-synchronizer.html) to keep the Bonita BPM organization synchronized with it.