...
- **URL**  
  ...
  _Example_: Get the supervisors of type `User` for the process [`8040901`](https://github.com/bonitasoft/bonita-doc/commit/8040901857674754544): `API/bpm/processSupervisor?c=5&d=user_id&f=process_id%3D8040901857674754544&f=user_id%3D>0&f=group_id%3D-1&f=role_id%3D-1&p=0`
- **Method**  
  `GET`
- **Data Params**  
  [Standard search parameters](rest-api-overview.md#resource_search) are available.  
...
- **URL**  
  ...
  _Example_: Get connector dependencies of the email connector (version 1.0.0) of the process with id = [`4971555`](https://github.com/bonitasoft/bonita-doc/commit/4971555129176049183): `/API/bpm/processConnectorDependency?c=10&p=0&f=connector_process_id=4971555129176049183&f=connector_name=email&f=connector_version=1.0.0`
- **Method**  
  `GET`
- **Data Params**  
  [Standard search parameters](rest-api-overview.md#resource_search) are available.  
...
- **URL**  
  ...
  - Get information about connectors attached to a process instance with instanceId [`4781948`](https://github.com/bonitasoft/bonita-doc/commit/4781948523999597477): `/API/bpm/connectorInstance?p=0&c=10&f=containerId%3d4781948523999597477`
- **Method**  
  `GET`
- **Data Params**  
  [Standard search parameters](rest-api-overview.md#resource_search) are available.  
