...
In order for your process to be able to perform operation on business data such as the classical create, read, update and delete operations you need to include business variables in your process.
