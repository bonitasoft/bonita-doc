...
* [Layout](/layouts.html)
* [Theme](/themes.html)
* [API extension](/rest-api-extensions.html)
...
If you are using [REST API authorization](/rest-api-authorization.html) and your resource needs the Web REST API, 
...
If you have specified a resource permission that is not defined in the [REST API authorization configuration](/rest-api-authorization.html) and REST API authorization is configured to be on, you will see an error message.

After a resource is added to the portal, it can be used in an [application](/applications.html) or in[a custom profile](#custom-profiles-2).
