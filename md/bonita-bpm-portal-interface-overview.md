...
Note: A user with an admin profile has to be created by the technical user in order to manage the organization and other users. See [First steps after setup/Create an Administrator user](/first-steps-after-setup.html).

See also [Profiles overview](/profiles-overview.html).

See also [Custom profiles](/custom-profiles.html).
