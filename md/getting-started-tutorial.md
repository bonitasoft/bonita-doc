...
The next stage is to define who carries out the steps in the process. This is done by assigning [actors](/actors.html). 
...
Hidden
`formInput.status == 'approved'` (click on "bind" icon)
