...
_Design a task contract and associated operations to update a business object with a multiple reference._
  ...
  * [Create the business object model](#bdm)
  * [Design the expense report process](#process)
  	* [Design the task contract to update expenses](#contract)
  	* [Add operations to update the business data](#operations)
  * [Run the process](#run)


## <a name="bdm"></a>Create the business object model

Create an **Expense** business object like below.

![Expense business object](images/bdm-tuto/bdm-expense.png "Expense business object")

Then create **ExpenseReport** business object referencing multiple expenses by composition.

![Expense report business object](images/bdm-tuto/bdm-expense-report.png  "Expense report business object")

##  <a name="process"></a>Design the expense report process
...
###<a name="contract"></a> Design the task contract to update expenses

* Select the **Update expense report** task
* Go to Execution > Contract property tab
* Create a contract like below

![Contract](images/bdm-tuto/contract.png "Contract")
...
###<a name="operations"></a> Add operations to update the business data
...
![](images/bdm-tuto/form1.png) 
![](images/bdm-tuto/form-2.png) 
