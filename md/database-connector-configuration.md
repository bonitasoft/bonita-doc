...
You can also use the [graphical query builder](/graphical-query-builder.html) to specify the query. Click _**Next**_.
...
7. Specify the output operations, using the [Graphical mode](/initialize-a-variable-from-a-database-without-scripting-or-java-code.html) or using expressions.
...
The Graphical mode does not require scripting. Click _**Next**_.
6. Specify the output operations, using the [Graphical mode](/initialize-a-variable-from-a-database-without-scripting-or-java-code.html) or using expressions.
