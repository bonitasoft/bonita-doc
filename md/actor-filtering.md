...
* _Users with Custom information_ is a new actor filter used to assign tasks to users based on [custom information](/custom-user-information-in-bonita-bpm-studio.html) (available from 6.3.2).
...
You can also create additional actor filters by creating the necessary files directly, as described in [Creating an actor filter](/creating-an-actor-filter.html).

For details of how to apply an actor filter to a task or lane, see [Actors](/actors.html).
