...
- Generally speaking, custom code and connectors might require updated version of libraries used in Bonita. If that the case, those updated versions should be added as script/connector dependencies.
