...
* BST-434 Studio does not inform Dave when the deployment of REST API Extension fails
* BST-466 autogenerated edit form with multiple documents can't be submited
* BST-469 Regression: Option "On exit clean database" doesn't work anymore
