...
#### BDM Api removal
Since 7.0, BDM APIs and model classes in `com.bonitasoft.engine.bdm.*` packages where deprecated in favor of the Community version in `org.bonitasoft.engine.bdm.*` packages.  
