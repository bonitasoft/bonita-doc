...
1. To import the Business Data Model created in Bonita BPM Studio, first [](/define-and-deploy-the-bdm.html#exportabdm)export the Business Data Model from Bonita BPM Studio where it was designed.
...
4. Click on **Pause** to [](/pause-and-resume-bpm-services.html)pause the tenant.
...
12. Click on **Resume** to [](/pause-and-resume-bpm-services.html#how_unpause)resume tenant activity.
