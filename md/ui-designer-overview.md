...
The UI Designer is part of the development tool integrated in Bonita Studio. It runs in a tomcat instance managed by Studio. This tomcat instance is separated from the engine/portal tomcat instance.
