...
3. As we want to test processes build with a Bonita BPM Subscription edition, you need to [configure the required Maven artifacts](/create-your-first-project-with-the-engine-apis-and-maven.md#maven_dependencies). 
