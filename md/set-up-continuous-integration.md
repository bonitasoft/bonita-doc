...
See the [BonitaStudioBuilder documentation](/automating-process-builds.html) for information on script options.
  3. 
...
2. [Configure local access](/configuring-bonita-home-for-a-client.html) to Bonita BPM Engine.
3. As we want to test processes build with a Bonita BPM Subscription edition, you need to [configure the required Maven artifacts](/create-your-first-project-with-the-engine-apis-and-maven.html#maven_dependencies). 
