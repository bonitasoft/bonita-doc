...
With the Efficiency, Performance and Entreprise editions, an Administrator can do a task for another user. This is useful for unblocking a case if the assigned user cannot perform a task.
...
This feature is available with the Entreprise or the Performance edition.
