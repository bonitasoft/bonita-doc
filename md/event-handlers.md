...
This example shows an event handler that detects changes in the state of activity instances. When executing, the event handler calls [technical logger service](/technical-logging.html).
