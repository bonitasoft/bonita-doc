...
You can automatically [migrate the platform from an earlier version of Bonita](migrate-from-an-earlier-version-of-bonita.md). You cannot migrate your platform from a version earlier than 6.0.2\. 
...
To migrate to a newer version of Bonita Studio, install the new version using the [Studio installer wizard](bonita-studio-installation.md) for your operating system.
...
A process definition created using Bonita 6.x can be run on this version after the [platform migration](migrate-from-an-earlier-version-of-bonita.md). 
