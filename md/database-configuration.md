...
:::info
CREATE TABLE and CREATE INDEX are not required after first start in normal use. If the same SQL user is used with migration tool, then this user needs this grants.
:::
