...
* Add new migration mode to migrate old V6 (GWT) Case Overview to new V7 autogenerated Case Overview pages
  in order to ease the migration to 7.8.0+
* BS-19473 - Migration to 7.8.0 does not work on multitenant environments
