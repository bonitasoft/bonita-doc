...
## 2.40.3 - May. 31th, 2019 (Bonita 7.8.4)
...
* the log file now shows timestamp for each log event
* the database connection pool initial and max sizes are now configurable
