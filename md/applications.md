...
::: info
Since 7.5, An application developpement tool has been integrated to the studio for efficiency and performance editions, it is recommanded to use it. More details here: [Application descriptors](applicationCreation.md)
:::
