...
To deploy the applications into a Tomcat bundle or the Cloud, you can use [Bonita Continuous Delivery](https://documentation.bonitasoft.com/bcd//_manage_living_application)(for Enterprise, Performance, Efficiency, or Teamwork editions).  
