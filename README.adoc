...
This repository contains the sources of the https://documentation.ofelia.com/bonita[Bonita documentation site]. It uses the https://docs.asciidoctor.org/asciidoc/latest/[AsciiDoc] format for the documentation content.
...
* http://community.ofelia.com/[Community website]
