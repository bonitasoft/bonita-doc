...
It provides *deep visibility of process execution* across the organization through its embbeded end-user applications or the xref:ROOT:applications.adoc[Living applications] built by the project team to perfectly fit the business needs.
