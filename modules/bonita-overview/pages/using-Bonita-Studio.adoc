...
To learn how to draw a process, go to the xref:ROOT:draw-bpmn-diagram#_create_the_process_diagram[Getting started tutorial], or read this xref:process:diagram-overview.adoc[documentation page].
