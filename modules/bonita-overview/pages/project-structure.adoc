...
|xref:ROOT:diagram-overview.adoc[Diagrams]
|BPMN diagram that describes your business processes
|Create
|Studio
|--

|xref:ROOT:forms.adoc[Forms]
...
|xref:ROOT:define-and-deploy-the-bdm.adoc[Business Data Model] (BDM)
...
|xref:ROOT:organization-overview.adoc[Organization] (for "Actors" and "Profiles")
...
|xref:ROOT:applicationcreation.adoc[Application descriptor]
...
|Studio or xref:ROOT:customize-living-application-theme.adoc[Dedicated SDK] (custom theme)
|--
...
|xref:ROOT:actor-filtering.adoc[Actor Filters]
...
|xref:ROOT:customize-living-application-theme.adoc[Dedicated SDK]
