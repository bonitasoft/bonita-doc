...
* xref:data:define-and-deploy-the-bdm.adoc[Define the Business Data Model], business variables, and xref:contracts-and-contexts.adoc[contracts]
* Define the xref:identity:organization-overview.adoc[organization] and xref:actors.adoc[actors]
