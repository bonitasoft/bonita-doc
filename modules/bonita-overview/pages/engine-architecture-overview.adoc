...
:page-aliases: ROOT:engine-architecture-overview.adoc
...
The Bonita Engine component services are completely configurable using the xref:ROOT:bonita-platform-setup.adoc[plaform setup tool] to retrieve the current configuration and update it.
...
These files can be retrieved and updated using the xref:ROOT:bonita-platform-setup.adoc[platform setup tool].
