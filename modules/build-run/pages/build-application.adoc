...
* `mvn clean package -Penv-MyConfig`: Where `MyConfig` is the name of one of your custom configuration. Using this profile ensures that the application is built with all the necessary Maven dependencies included.
