...
image::getting-started-tutorial/declare-contracts/contract-MVC.PNG[contract-mvc]
...
+
image:getting-started-tutorial/declare-contracts/declare-process-instantiation-contract.gif[Declare process instantiation contract]
...
+
image:getting-started-tutorial/declare-contracts/declare-user-task-contract.gif[Declare user task contract]
...
image:getting-started-tutorial/declare-contracts/operation.png[Operation]
====
