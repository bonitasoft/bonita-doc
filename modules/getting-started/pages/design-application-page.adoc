...
// @UIB xref:ui-builder:applications/initiation-manual.adoc[document section]
document section to learn how to use Bonita UI Builder to make application pages.
====
