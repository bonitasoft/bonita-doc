...
. Click on the *UI Designer* icon image:getting-started-tutorial/design-application-page/ui-designer.png[UI Designer icon] in the Bonita Studio tool bar
...
. Click on *Create*
+
image:getting-started-tutorial/design-application-page/creation-of-an-application-page.gif[Creation of an application page]
...
. In the top left corner of the UI Designer, click on  *Data model* image:getting-started-tutorial/design-application-page/data-model.png[Data model button]
...
. Click on *Save*
+
image:getting-started-tutorial/design-application-page/declare-claims-page-variable.gif[Declare claims page variable]
...
+
image:getting-started-tutorial/design-application-page/variables.png[variables]
...
+
image:getting-started-tutorial/design-application-page/dashboard-page.png[dashboard page]
...
image:getting-started-tutorial/design-application-page/dashboard-page-preview.png[dashboard page preview]
...
[NOTE]
====
This Getting Started tutorial is using Bonita UI Designer, which is a development environment that will be phased out
 as we fully transition to Bonita UI Builder. Bonita UI Builder allows for designing all kind of interfaces, forms
 and pages, without distinction. Check out the dedicated
 xref:{bonitaUiBuilderVersion}@ui-builder:getting-started:initiation-manual.adoc[document section] to learn how to
 use Bonita UI Builder to make application pages.
====
