...
The look & feel can be fully customized by modifying the xref:ROOT:layouts.adoc[layout] and adding a custom xref:customize-living-application-theme.adoc[theme].
====
