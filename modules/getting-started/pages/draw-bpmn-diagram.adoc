...
====
You can look at the diagram already drawn: In the project explorer, click on the *process diagrams* arrow, and then double-clik on *claimManagementDiagram-1.0.proc*.
====
...
As we recommend to do for every project, we use an iterative approach in the project development. +
