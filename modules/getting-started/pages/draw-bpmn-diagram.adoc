...
[TIP]
====
You can look at the diagram already drawn in the Getting Started project ready for download on Bonita Studio's Welcome page:

. In the project explorer, click on the *process diagrams* arrow, and then double-clik on *claimManagementDiagram-1.0.proc*
====

To design this process we will use the Business Process Model and Notation (BPMN) standard. You do not need to learn everything about BPMN to follow this tutorial but, if you would like to know more, you can read the https://www.bonitasoft.com/library/the-ultimate-guide-to-bpmn2[Ultimate Guide to BPMN 2.0].
...
[TIP]
====
If you have downloaded the Getting Started Tutorial project, for _Diagram Version_ and _Pool version_, input _"2.0"_. 
====
