...
[WARNING]
====
Docker images used to be accessible from quay.io. Usage of quay.io is now depreciated in favor of the Bonita Artifact Repository.
====
...
[source, shell, subs="+attributes"]
----
docker pull {bonitasoft-docker-repository}/docker/bonita-subscription:2022.2
----
