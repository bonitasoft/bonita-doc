...
The {javadocUrl}/api/{javadocVersion}/index.html[Bonita Engine APIs] enable you to:
...
Included in the {javadocUrl}/api/{javadocVersion}/index.html[Engine APIs] are methods to import and export various items.
