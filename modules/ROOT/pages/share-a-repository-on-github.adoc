...
:description: Share a project on Github
...
.. If needed, enter your GitHub username and password (the password field can also be used for the authentication token) in the Authentication form +
.. Click on "Next" +
