...
*Note:* If you are using MySQL, add `?allowMultiQueries=true` to the URL. For example, `db.url=jdbc:mysql://localhost:3306/bonita-update?allowMultiQueries=true`. 
...
=== License
Put a new license in the database: see xref:bonita-platform-setup.adoc#update_platform_conf[Runtime configuration] for further details.
