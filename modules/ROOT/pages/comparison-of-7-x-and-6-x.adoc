...
. Bonita Subscription Pack edition version for Enterprise, Performance, Efficiency, and Teamwork editions
. and Bonita Community edition version for the Community edition
