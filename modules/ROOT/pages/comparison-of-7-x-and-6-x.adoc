...
| No change for users. For administrators, the case process and case monitoring views have been improved, new live update features have been added, and the application editor has been improved. See xref:bonita-applications-interface-overview.adoc[Bonita Portal interface overview]
