...
| No more bonita_home. Relevant information is stored in the database, increasing performance and easing future migrations. See xref:bonita-platform-setup.adoc[platform setup]
|===
