...
====info
*Note:* Bonita uses http://www.keycloak.org/[Keycloak] as SAML Service Provider adapter.
====
...
*Note 3:* More configuration options can be found in https://www.keycloak.org/docs/latest/securing_apps/index.html#_saml-general-config[Keycloak official documentation]
====
