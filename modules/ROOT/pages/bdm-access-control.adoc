...
. Login onto the platform as a user with the profile _HR trainee_.
...
. Login into the platform as a user with the profile _HR manager_. Refresh the application in the web browser. You are viewing the application as an HR manager. The medical comment is displayed.
...
. Login into the platform as a user with the profile _Order picker_.
. In the Studio, open the application descriptor
. Click on the overview link of the application. Customer data and product prices are not displayed.
. Login into the platform as a user with the profile _Experienced Sales_. Refresh the application in the web browser. All data are displayed.
. Login into the platform as a user with the profile _Novice Sales_. Refresh the application in the web browser. Full invoice information is displayed. Only customer data names are displayed.
...
. Login into the platform as a user with the profile _Mathamtics Teacher_.
. In the Studio, open the application descriptor
...
. Login into the platform as a user with the profile _Physics Teacher_. Refresh the application in the web browser. Select 'Mathematics'. No instances are displayed but you can see instances when you select 'Physics'.
. Login into the platform as a user with the profile _Teachers_. Refresh the application in the web browser. All instances are available to you.
