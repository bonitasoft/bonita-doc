...
:page-aliases: bonita-bpm-installation-overview.adoc
...
For Bonita Subscription editions, you need to xref:licenses.adoc[install a license] during the installation procedure. This license depends on the edition, the deployment environment, the number of cases purchased or the number of cores.
...
* If you want to migrate an existing installation to the latest version follow the xref:version-update:update-with-migration-tool.adoc[migration guide].
