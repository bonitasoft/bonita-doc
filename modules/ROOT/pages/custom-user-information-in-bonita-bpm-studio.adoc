...
Note: this value can be changed by a user with the Admin profile in the Bonita Portal. See xref:custom-user-information-in-bonita-bpm-applications.adoc[How to edit Custom information for a single user]
