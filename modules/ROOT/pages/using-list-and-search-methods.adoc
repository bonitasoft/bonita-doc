...
you can have an OR clause, of more complex clauses. See http://documentation.bonitasoft.com/javadoc/api/{javadocVersion}/org/bonitasoft/engine/search/SearchOptionsBuilder.html[SearchOptionsBuilder methods] for filtering that matches your needs. +
