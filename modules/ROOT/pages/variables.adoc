...
====info
Read xref:ui-designer-overview.adoc]#integration-with-bonita-platform[Integration with Bonita Platform] to know how Business Data are connected with Bonita Platform.
====
