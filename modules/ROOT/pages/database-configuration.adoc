...
To use Bonita BPM on another RDBMS, please use a xref:bonita-bpm-installation-overview.adoc[bundle] or set up a xref:deploy-bundle.adoc[standalone server].
====
