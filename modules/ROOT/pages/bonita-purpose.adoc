...
* xref:bonita-bpm-applications-interface-overview.adoc[Bonita User application] is one of the Bonita Applications that is visible to process users, who can use it to view tasks and take actions thanks to a generic task list for all processes they are involved in.
