...
In order for preview to access the data, a user needs to be logged in to the Bonita platform. You can click on *Applications* in the Bonita Studio tool bar to make sure a user is logged in.
====
