...
For Enterprise and Performance edition only.
====
...
[WARNING]
====
Cache org.bonitasoft.engine.core.process.instance.model.impl.SFlowNodeInstanceImpl Key org.bonitasoft.engine.core.process.instance.model.impl.SFlowNodeInstanceImpl#org.bonitasoft.engine.persistence.PersistentObjectId@25505ff
Lockable : null
...
Bonita Engine uses the xref:engine-architecture-overview.adoc[Scheduler service] to trigger jobs in a recurrent manner.
