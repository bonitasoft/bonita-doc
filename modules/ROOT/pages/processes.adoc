...
. Click *_Processes_*
. Click *_Resolved filter_*
. Select the process
. Click *_More_* button_
. Click *_Enable_*
...
. A list appears filled with the actors you can to remove. You can undo a removal by clicking *_X_* button next to the actor or by clicking *_Enable all_*
. Click *_APPLY_*.
