...
Custom connectors are added to a Bonita project with the extension viewer.
...
Custom actor filters are added to a Bonita project with the extension viewer.
...
Custom REST API extension developed with the maven archetype are added to a Bonita project with the extension viewer.
