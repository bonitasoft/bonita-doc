...
You can then use your custom widget in pages, forms, and fragments - for Subscription editions.
...
[NOTE]
====
Below extension points are available only for subscription editions. 
====
