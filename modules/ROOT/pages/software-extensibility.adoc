...
Custom connectors are added to a Bonita project with the xref:managing_extension_studio.adoc[extension view].
...
Custom actor filters are added to a Bonita project the xref:managing_extension_studio.adoc[extension view].
...
REST API Extension can either created in the xref:rest-api-extensions.adoc[Studio] or with the xref:rest-api-extension-archetype.adoc[dedicated maven archetype].
