...
Custom REST API extension developed with the maven archetype are added to a Bonita project with the xref:managing_extension_studio.adoc[extension view].
...
Custom theme are developped outside the Studio with a dedicated maven archetype. Consult this page for more information:xref:customize-living-application-theme.adoc[Create an theme]
