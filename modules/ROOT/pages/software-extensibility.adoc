...
Java class respecting the http://documentation.bonitasoft.com/javadoc/api/{javadocVersion}/index.html[Connector interface].
...
you need to provide some XML description files and a Java class respecting the http://documentation.bonitasoft.com/javadoc/api/{javadocVersion}/index.html[UserFilter interface].
...
The http://documentation.bonitasoft.com/javadoc/api/{javadocVersion}/index.html[Bonita Engine APIs] enable you to:
...
Included in the http://documentation.bonitasoft.com/javadoc/api/{javadocVersion}/index.html[Engine APIs] are methods to import and export various items.
