...
Connectors are developped outside the Studio with a dedicated Maven archetype. Consult this page for more information: xref:connector-archetype.adoc[Create a connector].

Custom connectors are added to a Bonita project from the xref:managing_extension_studio.adoc[extension view].
...
Actor filters are developped outside the Studio with a dedicated Maven archetype. Consult this page for more information:xref:actor-filter-archetype.adoc[Create an actor filter]

Custom actor filters are added to a Bonita project from the xref:managing_extension_studio.adoc[extension view].
...
REST API Extension can either be created in the xref:rest-api-extensions.adoc[Studio] or with the xref:rest-api-extension-archetype.adoc[dedicated Maven archetype].

Custom REST API extensions developed with the Maven archetype are added to a Bonita project from the xref:managing_extension_studio.adoc[extension view].

=== Custom pages

In Community, Teamwork, Efficiency, Performance and Enterprise editions

A xref:pages.adoc[custom page] is a page that you can add into Bonita Administrator Application to form part of an application or to customize information provided in default Application pages.
...
Custom themes are developed outside the Studio with a dedicated Maven archetype. Consult this page for more information: xref:customize-living-application-theme.adoc[Create an theme]
...
Bonita Runtime comes with a number of language packs by default. You can also xref:languages.adoc[add languages].
