...
[.card.card-index]
--
xref:set-log-and-archive-levels.adoc[[.card-title]#Set recording levels# [.card-body.card-content-overflow]#pass:q[Define what you need to know about process execution (logs, archives)]#]
--

[.card.card-index]
--
xref:configurable-archive.adoc[[.card-title]#Configure the archiving of BPM elements# [.card-body.card-content-overflow]#pass:q[Finely select the BPM elements you need to archive]#]
--
