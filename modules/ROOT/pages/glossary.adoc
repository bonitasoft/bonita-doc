...
Delegation::
A mechanism that lets a delegate see and execute an absent user's assigned tasks, for a defined period and a chosen list of processes, without reassigning them. Available in Subscription editions only. See xref:runtime:user-delegation.adoc[Delegation].
