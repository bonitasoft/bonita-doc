= Applications
:description: This page defines the term "Application" and explains what a user with the Administrator profile in Bonita Portal can see and do about them.
...
To access the application content, you must pertain to the xref:profiles-portal-overview.adoc[profile] mapped with the application. +
