...
This page defines the term "Application" and explains what a user can see and do about them in the Bonita Administrator Application.
...
* The xref:bdm-management-in-bonita-bpm-applications.adoc[Business Data Model] (BDM) must be deployed
* The xref:organization-in-bonita-bpm-applications-overview.adoc[organization] data must be deployed, so that application users can log in.
