= Bonita Runtime dependencies (10.3.11)
...
| xbean-classloader
| 4.27
| http://geronimo.apache.org/maven/xbean/4.27/xbean-classloader[http://geronimo.apache.org/maven/xbean/4.27/xbean-classloader]
|  http://www.apache.org/licenses/LICENSE-2.0.txt[The Apache Software License, Version 2.0]
