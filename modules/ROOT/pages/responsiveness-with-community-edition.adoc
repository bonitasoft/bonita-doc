...
:description: To build a responsive page/form based on different screen sizes using UI Designer, there are several predefined bootstrap CSS classes.
...
Example:
image:images/responsiveness-community-edition/responsivenessCommunityEdition.PNG[bootstrap css classes]
