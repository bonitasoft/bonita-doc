...
To download the latest version of Bonita Studio Subscription edition, go to the https://csc.bonitacloud.bonitasoft.com/apps/CustomerServices/downloads/[Customer Service Center] and request the download of the version you need.
...
. Go to the https://csc.bonitacloud.bonitasoft.com/apps/CustomerServices/licenses/[Customer Service Center] and request a license using the request key in the clipboard
