...
Subscription editions cover the now unique Enterprise editions, but also the Performance, Efficiency, and Teamwork editions that are no longer sold but still supported at Ofelia. +
...
You are also ready to download and start using Bonita UI Builder. Check out our
xref:{bonitaUiBuilderVersion}@ui-builder:installation:download-and-launch.adoc[dedicated guide] to see how.
