...
Since 2024.1, all Bonita Studio packages comes with an embedded Java runtime. It uses https://eclipse.dev/justj[Eclipse JustJ, target="blank"] behind the hood.
