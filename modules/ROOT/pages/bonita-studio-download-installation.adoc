...
brew cask install java{minimalRequiredJavaVersion}
----

Another solution is to download and execute manually the installer, https://adoptium.net/temurin/releases/?version={minimalRequiredJavaVersion}&os=mac[here for example].
