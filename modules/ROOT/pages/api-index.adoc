...
[.card.card-index]
--
xref:rest-api-extension-archetype.adoc[[.card-title]#Create a REST API extensions# [.card-body.card-content-overflow]#pass:q[Tools to develop and test your Rest API Extensions]#]
--
