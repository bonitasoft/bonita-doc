...
See xref:bonita-bpm-platform-setup.adoc#update_platform_conf[setup tool page] for more information.


== Troubleshoot and debug problems inside a Docker container

Bonita pass:a[{bonitaVersion}] docker image comes with a use tool embedded, xref:https://github.com/apangin/jattach[jattach], that allows to interact with the Tomcat JVM inside a Bonita container via Dynamic Attach mechanism.
...
JVM response code = 0
-XX:CICompilerCount=4 -XX:ConcGCThreads=2 -XX:G1ConcRefinementThreads=8 -XX:G1HeapRegionSize=1048576 -XX:GCDrainStackTargetSize=64 -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/opt/bonita/BonitaSubscription-2021.1-SNAPSHOT/server/logs
```
...
com.arjuna.ats.arjuna.common.propertiesFile=/opt/bonita/BonitaSubscription-2021.1-SNAPSHOT/server/conf/jbossts-properties.xml
sysprop.bonita.bdm.db.vendor=h2
awt.toolkit=sun.awt.X11.XToolkit
java.specification.version=11
sun.cpu.isalist=
sun.jnu.encoding=ANSI_X3.4-1968
java.class.path=/opt/bonita/BonitaSubscription-2021.1-SNAPSHOT/server/lib/ext/bonita-tomcat-juli-7.12.8-SNAPSHOT.jar\:/opt/bonita/BonitaSubscription-2021.1-SNAPSHOT/server/bin/bootstrap.jar\:/opt/bonita/BonitaSubscription-2021.1-SNAPSHOT/server/bin/tomcat-juli.jar
