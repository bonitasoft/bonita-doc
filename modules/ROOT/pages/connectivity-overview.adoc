...
:page-aliases: connectors-overview.adoc
...
[NOTE]
====
To use connectors in your processes, you first need to import the corresponding extensions from the xref:managing_extension_studio.adoc[extension view].
====
