...
*Problem:* This issue arise if you are using a self-signed certificate or a certificate that’s been issued by an internal certificate authority, or if your certificate is outdated.  
...
. Make sure you used keytool to install the new certificat. More info online: http://docs.oracle.com/javase/8/docs/technotes/tools/windows/keytool.html  
