...
An application page accesses business data using the xref:ROOT:bdm-api.adoc[bdm REST API]. A page also contains page xref:pages-and-forms:variables.adoc[variables], which have no meaning outside the page.
