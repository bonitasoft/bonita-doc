= Fragments
:description: A fragment is a piece of a page, form or layout, composed of one or more widgets and/or containers. It can be inserted in other pages.
...
Available in the Bonita Enterprise, Performance, Efficiency, and Teamwork editions only.
====
