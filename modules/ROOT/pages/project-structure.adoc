...
Note that not all elements are required and they are alternative ways of doing. However, using the provided elements enables to the full potential of the Bonita platform.
...
|A couple are provided and you can create custom actor filters
|Studio or SDK (custom connectors)
|-

|Connectors
|Web interfaces used for human interactions with your processes
|A dozen connectors are provided and you can create custom connectors
|Studio or SDK (custom connectors)
|-
...
== Extensions
Bonita automation project can extended by creating custom components. These are called extensions.

Some extensions are used to add elements to those provided while other are used to enable more possibilities to the platform.
