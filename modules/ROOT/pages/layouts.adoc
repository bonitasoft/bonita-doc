...
You can link:resource-management.md#modify[edit the content of a layout] by installing a new version.

=== Modify the pages in an application

You can link:applications.md#define-navigation[link another layout to an application] in the application descriptor.
