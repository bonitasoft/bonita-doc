...
Bonita also provides a http://documentation.bonitasoft.com/javadoc/api/{javadocVersion}/index.html[PlatformMonitoringAPI] that you can use to obtain some of this information.
...
These parameters can be obtained through monitoring system like Nagios or Zabbix. You can also retrieve them using the http://documentation.bonitasoft.com/javadoc/api/{javadocVersion}/index.html[PlatformMonitoringAPI].
...
You can also get the number of active transaction using the http://documentation.bonitasoft.com/javadoc/api/{javadocVersion}/index.html[MonitoringAPI].
