...
[#SQLServer2017]
== Migrating to Bonita 7.11+ using SQL Server
...
In addition, if your application connects to the Bonita Engine using the HTTP access mode, see the xref:configure-client-of-bonita-bpm-engine.adoc[bonita-client library]
documentation page.
