...
order to activate Active Directory/LDAP authentication the service implementation needs to be changed. To do this, edit xref:bonita-platform-setup.adoc[`bonita-tenant-sp-custom.properties`].
