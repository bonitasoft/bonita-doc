...
To deploy the applications into a bundle or the Cloud, you can use xref:3.6@bcd::bcd_cli.adoc[Bonita Continuous Delivery] (for Subscription editions using BCD).
