...
. To add a user, click the *_Plus sign or Pencil button_* in the *_User_* column. A popup shows a list of the users who are currently process managers for this process.
