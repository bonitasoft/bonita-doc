...
* Core applications. They are critical to the good operation of Bonita in a Production environment. They can be customized but they cannot be deleted:
  ...
  ** Super Administrator
* Generic applications. They are fully functional, can be customized, but can be deleted if not useful in a Production environment:
  ** Administrator
  ** User
...
[.card.card-index]
--
xref:super-administrator-application.adoc[[.card-title]#Super Administrator# [.card-body.card-content-overflow]#pass:q[The tool to bootstrap a Bonita Runtime, perform maintenance actions, and update the BDM]#]
--
