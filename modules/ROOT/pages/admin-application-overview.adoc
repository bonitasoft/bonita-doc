...
To deploy the applications into a bundle or the Cloud, you can use xref:3.4@bcd::livingapp_deploy.adoc[Bonita Continuous Delivery] (for Bonita Subscription and using BCD).
