...
To deploy the applications into a bundle or the Cloud, you can use {bcdDocVersion}@bcd::bcd_cli.adoc[Bonita Continuous Delivery] (for Bonita Subscription and using BCD).
