...
:description: Discover how to monitor a running Bonita Runtime environment

 Discover how to monitor a running Bonita Runtime environment
...
Bonita provides a series of technical and Bonita-related metrics to monitor the health of a Bonita Runtime environment. +
Some metrics are enabled by default and cannot be disabled. Others are optional and can be enabled according to
your needs.
