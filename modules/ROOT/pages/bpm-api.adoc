...
`GET`
* *Success Response* +
The process design object. The JSON returned is a representation of the http://documentation.bonitasoft.com/javadoc/api/{javadocVersion}/index.html[DesignProcessDefinition] instance of the given process id.
 ** *Code*: 200
