...
:description: This page explains the REST API permissions for the Super Administrator profile.

{description}. More information about how this page is structured can be found xref:default-api-call-permissions-overview.adoc[in this page]. +
