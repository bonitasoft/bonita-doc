...
[.card.card-index]
--
xref:release-notes.adoc#project-explorer[[.card-title]#Project explorer in the studio# [.card-body.card-content-overflow]#pass:q[View, manage, and search all Bonita project resources from one location in the Studio]#]
--

[.card.card-index]
--
xref:release-notes.adoc#uipath[[.card-title]#Bonita integrates Robotic Process Automation# [.card-body.card-content-overflow]#pass:q[New UiPath connectors to let employees focus on tasks with high added-value]#]
--

[.card.card-index]
--
xref:release-notes.adoc#modal[[.card-title]#New modal container in the UI Designer# [.card-body.card-content-overflow]#pass:q[Improve end-users experience with modal windows on pages and forms]#]
--

[.card.card-index]
--
xref:release-notes.adoc#callback[[.card-title]#Call back Bonita asynchronously from an external service# [.card-body.card-content-overflow]#pass:q[No need to listen for the end of the service anymore: use the new REST API]#]
--
