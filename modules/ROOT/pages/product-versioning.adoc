...
<xmi:XMI xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI"
         ...
         xmlns:configuration="http://www.bonitasoft.org/ns/studio/configuration"
         ...
         xsi:schemaLocation="http://www.bonitasoft.org/ns/studio/process/decision http://www.bonitasoft.org/ns/studio/process#//decision">
