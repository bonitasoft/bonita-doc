...
It saves you from doing all the following configuration at hand, as the xref:bonita-bpm-platform-setup.adoc[setup tool] included handles it automatically.
====
