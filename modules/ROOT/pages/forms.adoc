...
You can link:live-update.md#form-list[update the form in the list] and link:live-update.md#form-mapping[modify the mapping with the process]. +
You can also link:resource-management.md#modify[edit] a global form as a resource in Bonita Portal.
