...
* Download Bonita  xref:tomcat-bundle.adoc[Tomcat bundle] or  xref:wildfly-bundle.adoc[WildFly bundle], that contains the platform setup tool, and unzip it at some place of your choice.
