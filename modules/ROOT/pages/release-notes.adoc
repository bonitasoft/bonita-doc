...
=== Fixes in Bonita 2022.2-u1 (2022-12-01)
...
* RUNTIME-1477 - Fix [admin-case-details] improve function to display Started by information
* RUNTIME-1478 - Fix [admin-task-details] improve function to display Executed by information
* RUNTIME-1483 - Fix [Security] Uncontrolled Resource Consumption in Jackson-databind
* RUNTIME-1485 - Fix [SSO] Allow the usage of any claim of the ID token for the OIDC adapter to fetch the username value from
* RUNTIME-1489 - Fix [Security] Version update of several dependencies for 2022.2-u1 (7.15.1)
