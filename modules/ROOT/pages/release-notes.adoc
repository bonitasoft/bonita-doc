...
Community users that update to 2022.1 simply lose the possibility to use dynamic authorization checking, and their potential previous configuration regarding dynamic authorizations is automatically cleared out from the installation, during the update procedure.
