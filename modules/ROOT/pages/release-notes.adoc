...
* create a custom theme out of the provided themes and add the font-awesome library to it (as explained in the xref:7.9@themes.adoc[documentation for version 7.9])
