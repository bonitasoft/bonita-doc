...
====
For the 2023.2 Bonita version, we will keep the platform mode in parallel with the SCA mode which is Bonitasoft's recommendation in order to correspond to market standards from an application development point of view.
