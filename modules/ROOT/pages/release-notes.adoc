...
=== Fixes in Bonita 2024.3-u11 (2026-09-23)
...
* Hazelcast, the library used by the Cluster feature, is updated from 5.4.0 to 5.7.0. If you run a cluster, read <<v2024-3-u11-cluster-update,Updating a cluster to 2024.3-u11>> before updating.
...
[#v2024-3-u11-cluster-update]
*Updating a cluster to 2024.3-u11*
