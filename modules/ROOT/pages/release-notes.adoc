...
The rich text editor used to edit an email message does not work on Linux since the `libwebkit2gtk-4.0-37` package has been updated to `2.32.0+`. Linux users can use the plain text editor or a script expression to edit their email's message body.
