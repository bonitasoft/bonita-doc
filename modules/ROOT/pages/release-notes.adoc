...
The formerly named `bonita-update-tool.sh/.bat` script has been renamed to `bonita-update.sh/.bat`.

Moreover, the Subscription version of the script is also named `bonita-update.sh/.bat`. (there is no `-sp` suffix anymore)
