...
* CVE-77 - Improper verification of SAML responses leading to impersonation attacks in Keycloak SAML adapter
* CVE-78 - Apache Tomcat - Potential RCE and/or information disclosure and/or information corruption with partial PUT
