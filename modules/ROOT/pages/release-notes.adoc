...
This migration now happens in a wizard which let you examine and execute the migration steps one by one, or cancel the whole operation any time you wish. You can also execute them all in batch if you do not want the details. +
