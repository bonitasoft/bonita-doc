...
==== Extension creation
You can longer create custom connectors, Groovy scripts, themes and actors filters in the Studio. These need to be coded outside the Studio as Maven dependencies (see our Maven archetypes)
...
* RUNTIME-960 Update Mysql driver to 8.0.28
* RUNTIME-961 Update Spring to 5.2.22.RELEASE
