...
Custom Profiles with a Portal navigation will be automatically convertedto _custom applications_ upon Bonita update. Therefore, be extra-careful during the Bonita update procedure.
====
