...
. *You customized the Bonita User Application*: edit your user application to add the user Delegations page (`page-user-delegation`) to your custom user application's menu entries.
...
The same applies to the Bonita Administrator Application, but for the admin Delegations page (`page-admin-delegation`).
