...
For how to set up and use delegation, see xref:runtime:user-delegation.adoc[Delegation] (end users) and xref:runtime:admin-delegation.adoc[Delegations administration] (organization-wide management).
