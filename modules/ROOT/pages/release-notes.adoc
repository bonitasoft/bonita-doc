...
In Bonita 2021.2, custom profile navigation has been removed, and thus they are automatically converted into Living Applications by the xref:migrate-from-an-earlier-version-of-bonita-bpm.adoc[migration tool].
...
* RUNTIME-132 - [SAML] Getting the default logging page when signing in on a guest app
