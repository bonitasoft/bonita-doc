...
* STUDIO-4548 - After migration RestApi Extension failed with "org.bonitasoft.engine.bdm.BusinessObjectDaoCreationException: java.lang.ClassNotFoundException: com.md.model.WOMSOrderDAOImpl"
