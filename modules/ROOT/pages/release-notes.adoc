...
A page that is generated with this version is still compatible with a previous version and can be imported without any issued, but the debounce property will simply be ignored.
