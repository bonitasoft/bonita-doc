...
In Bonita 2021.2, custom profile navigation has been removed, and thus profiles with navigation are automatically converted into custom applications by the xref:version-update:migrate-from-an-earlier-version-of-bonita.adoc[migration tool].
