...
Based on the https://semver.org/[semantic versionning management standards], removing technically the multi-tenancy from Bonita Runtime is a breaking change and requires a technical version change. 
