...
A new xref:pages-and-forms:widgets-input.adoc#currency-input-widget[input widget] is now available in UI Designer to manage financial data using currencies at ease in pages or forms.
