...
* STUDIO-4228 - Case visu page is blank / Missing Pool--1.0.bar/resources/process.bpmn file when bar file generated with Project Explorer - RightClick - Build 
* STUDIO-4230 - NPE in Project explorer and lib folder 
* UID-589 - BDR: redirect stdout and stderr in log file, or at least catch parsing errors 
