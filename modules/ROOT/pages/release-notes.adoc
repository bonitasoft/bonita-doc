...
For the users of Bonita Community edition, Bonita 2021.2 also comes with all the bug fixes included in the Maintenance versions of Bonita 2021.1. +
See the list in xref:2021.1@Bonita:ROOT:release-notes#_fixes_in_bonita_2021_1_0307_2022_03_07.adoc[Bonita 2021.1 release notes].
