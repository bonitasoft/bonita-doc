...
== Welcome to our xref:bonita-applications-interface-overview.adoc[*four Bonita applications*]!

They beautifully replace our good old Bonita Portal, gone for retirement. +
...
Custom Profiles with a Portal navigation will be automatically convertedto _custom applications_ upon Bonita update. +
