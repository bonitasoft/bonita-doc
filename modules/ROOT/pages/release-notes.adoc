...
When building your process, process dependencies are now handled with maven and the configuration have been simplified to reduce the risk of error while selecting Java libraries.
