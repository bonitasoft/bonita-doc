...
* STUDIO-4452 - Deploying an organisation fails if a parent and child process instances are still running in the Studio's engine Tomcat
* STUDIO-4458 - Custom page name conflict not detected at deploy
* STUDIO-4460 - Fix variable resolution in the Groovy script editor
* STUDIO-4461 - Improve pre 2022.1 project dependencies migration with better detection of libraries with classifier
* STUDIO-4462 - Fix Validate action getting stuck with diagrams with Subprocess event figures.
...
* STUDIO-4455 - Fix refresh validation so that Groovy script validation marker does not disappear
