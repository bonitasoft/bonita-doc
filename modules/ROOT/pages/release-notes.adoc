...
[NOTE]
Please note that, due to an https://github.com/hazelcast/hazelcast/issues/24688[issue in recent Hazelcast versions], Hazelcast version was rolled back to 5.1.5 in order to fix RUNTIME-1716.
