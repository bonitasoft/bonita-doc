...
We are excited to announce the release of xref:{bonitaUiBuilderVersion}@ui-builder::index.adoc[Bonita
 UI Builder], our new and enhanced development environment for creating all kind of interfaces, pages and forms for your applications! It brings along a host of advanced features and improved usability, designed to help you create compelling, responsive, and user-friendly interfaces.
...
* Support and resources: We offer extensive documentation, tutorials, and support to help you make the most of xref:{bonitaUiBuilderVersion}@ui-builder::index.adoc[Bonita UI Builder]
...
You can now use application links. See xref:{bonitaUiBuilderVersion}@ui-builder::index.adoc[Applications with
Bonita UI Builder] for more details. Community users can also integrate their own links for applications developed with other tools.
