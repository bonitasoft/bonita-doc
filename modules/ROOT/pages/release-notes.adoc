...
* RUNTIME-1833 - SanitizerFilter should be disabled by default to avoid data loss when updating. Please visit the xref:security:sanitizer-security.adoc[HTML sanitizer filter] articale to evaluate the risks.
...
* CVE-62 - Regular Expression Denial of Service (ReDoS) in AngularJS page generated by the UI Designer
