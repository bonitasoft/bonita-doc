...
[WARNING]
====
The Studio can crash at start time of Bonita Studio with 2021.1-1122 version, on MacOS with the Intel architecture. The issue has not be detected on previous nor on future versions. Those facing the issue, can use Bonita Studio 2021.1-0920 instead. 
====
