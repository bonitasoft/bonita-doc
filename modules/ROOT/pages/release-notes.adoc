...
You can now create xref::identity:user-authentication-overview.adoc#_custom_login_page[a custom external login form] using the technology of your choice and set an environment variable to have Bonita runtime redirect to this custom login page instead of the default one.
