...
* STUDIO-4419 - Improve .bpmn file import error management when bpmn contains horizontal lanes
...
* RUNTIME-1408 - Fix slow REST API extension call due to a java sycnhronized in the handleRestApiCall method from RestApiRenderer class
