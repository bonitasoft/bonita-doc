...
* UID-453	- ResponsivenessHelp in editor help is not displayed
* UID-369	- Property type changes of target widgets are not mapped when using Switch feature
* UID-165	- When modifying & save an asset, if you press SUPR, the selected widget is removed


==== Fixes in Bonita Runtime (including Portal)

* RUNTIME-326	- Docker logs should not contain sensitive informations
