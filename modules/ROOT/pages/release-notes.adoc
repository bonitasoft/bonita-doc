...
It is now possible to retrieve "assigned" user tasks by using the case info xref:api:activities-tasks-flow-nodes-api.adoc#search-for-a-humantask[`bpm/caseInfo` REST API resource filters]. 
