...
During development, the Bonita Studio now allows you to launch Bonita UI Builder very easily (for production, the Studio is not used). See xref:applications:ui-builder/development-instance-from-studio.adoc[Development instance from Studio] for more information.
