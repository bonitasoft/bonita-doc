...
Bonitasoft has launched the open source project https://process-analytics.dev/[Process Analytics] two years ago, as a response to market's need in bpmn process monitoring execution using bpmn standards. +
