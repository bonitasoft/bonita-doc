...
* CVE-59       - IDOR due to to the lack of dynamic permissions in Community edition
_We would like to thank Mohammad A’mir for reporting this high severity issue to us._
