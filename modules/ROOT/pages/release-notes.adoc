...
[WARNING]
====
The Studio may crash at start time on MacOS with this version (2021.1-1122), especially with the Intel architecture. In this case, please use the version 2021.1-0920 instead.
====
