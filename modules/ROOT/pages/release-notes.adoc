...
=== AngularJs fix of version used by UID Artifact builder

In order to fix CVEs in the UID Artifact builder, we have made a fork of the AngularJs project and cherry-picked the fixes to the version that is used by the module.
