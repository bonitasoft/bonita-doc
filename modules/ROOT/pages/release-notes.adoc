...
* STUDIO-4121 - 7.12.7 studio get workspace corrupt when swiching projects
* STUDIO-4126 - Process execution errors: bcd-dependencies:7.11.5 generates a .bar different from Studio 7.11.5
* UID-432 - When openning a pop-up with a widget selected in whiteboard, the keybinding could get unexpected errors

==== Fixes in Bonita Runtime (including Portal)

* RUNTIME-45 -	Narayana / ARJUNA : Frequent warning messages in log files
* RUNTIME-590 -	Method onPrepareStatement with postgres breaks the search case insensitivity
