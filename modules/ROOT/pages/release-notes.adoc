...
For more information on how like-based search works, please refer to the xref:api:using-list-and-search-methods.adoc#like-based-search[dedicated documentation].
