...
== Self-contained applications Bundle Packager

As the first step of delivering the new concept of Self Contained Apps (based on multi-runtime architecture), the packaging tool permits to deploy Bonita’s application.
