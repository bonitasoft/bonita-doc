...
* {openApiUrl}/{openApiLatestVersion}#tag/businessData[POST bdm/businessData/+{businessDataType}+] to create a new business data object
* {openApiUrl}/{openApiLatestVersion}#tag/businessData[PUT bdm/businessData/+{businessDataType}+/+{ID}+] to update an existing business data object
* {openApiUrl}/{openApiLatestVersion}#tag/businessData[DELETE bdm/businessData/+{businessDataType}+/+{ID}+] to delete an existing business data object
* {openApiUrl}/{openApiLatestVersion}#tag/businessData[POST bdm/businessData/+{businessDataType}+/import] to import a CSV-formatted file for bulk import of new business data objects
