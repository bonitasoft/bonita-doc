...
The REST API resource xref:api:cases-process-instance-api#_caseinfo_subscription_editions_only[Case info `bpm/caseInfo`] which is used for case tasks visualization is now available in subscription editions only.
