...
== Bug fixes
For the users of Bonita Community edition, Bonita 2022.2 also comes with all the bug fixes released in the Maintenance versions of Bonita 2022.1.
...
* RUNTIME-869  - [Admin App]: BPM process: The 2 Popups to Disable and Enable installed process do not close
...
* RUNTIME-1147 - Office to PDF connector is not working on a 2022.1-u0 docker enterprise image
* RUNTIME-1248 - [Admin App]: Case list should not display the "view diagram" icon if the feature is not available
...
* RUNTIME-1408 - slow REST API extension requests due to a java sycnhronized block
