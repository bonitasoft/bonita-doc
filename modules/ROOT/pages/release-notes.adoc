...
* CVE-81 - Apache Tomcat - DoS in multipart upload
* CVE-82 - Apache Tomcat - Security constraint bypass for pre/post-resources
* CVE-83 - Apache Commons FileUpload - Allocation of resources for multipart headers with insufficient limits enabled a DoS
* CVE-84 - Apache Commons BeanUtils - Insufficient input validation may lead to remote code execution
