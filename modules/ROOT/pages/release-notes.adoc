...
* Hazelcast, the library used by the Cluster feature, is updated from 5.4.0 to 5.7.0. If you run a cluster, read <<v2024-3-u10-cluster-update,Updating a cluster to 2024.3-u11>> before updating.
