...
:page-aliases: BonitaBPM_platform_setup.adoc

:description: This page explains how to use Bonita Setup tool to configure the Bonita platform (properties, permissions, license install...).
...
First thing to know is that for all basic installation and start scenarios, you don't need to use Bonita Setup tool.
...
When I run Bonita Setup tool, I get the exception about database vendor
...
My database property is ignored in file database.properties
