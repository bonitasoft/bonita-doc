...
This tutorial is deprecated starting with Bonita 7.8 because of the introduction of the modal container as a provided container. For more information, read the xref:widgets.adoc]#modal-container[modal container] page.
====
