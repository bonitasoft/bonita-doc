...
:description: A nice aspect of Bonita UI Designer is that it allows users to apply or customize styles to the page as per their requirements through CSS.
...
*:fa-exclamation-triangle: Warning:* This tutorial is deprecated starting with Bonita 7.8 because of the introduction of the modal container as a provided container. For more information, read the xref:widgets.adoc#modal-container[modal container] page.
====
