...
:description: Learn how to set up a Maven client application that uses Bonita Engine APIs to communicate with Bonita Engine and run a process.
...
----
<properties>
   <bonita.bpm.version>pass:a[{varVersion}].0</bonita.bpm.version>
   ...
</properties>
