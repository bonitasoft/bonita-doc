...
== Troubleshooting
=== The Exception below is generated when the LDAP Synchronizer is used
...
=== Solution
==== On-premise: Configure the ZIP bundle you've downloaded from the bonitasoft Customer Service Center
