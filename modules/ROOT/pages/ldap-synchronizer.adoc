...
Bonita LDAP Synchronizer can be installed in two ways:



The installation of `ldap synchronization` could be done with two different :


* <<deploy-from-bundle, Install LDAP Synchronizer from Bonita Bundle>>
* xref:docker-ldap-synchronizer.adoc[Deploy LDAP Synchronizer with Docker] ( available since bonita *2021.1-0702*)


[[deploy-from-bundle]]
==== Install LDAP Synchronizer from Bonita Bundle
