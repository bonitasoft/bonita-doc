...
You can link:resource-management.md#modify[edit the content of a page] by installing a new version of a page.

=== Modify the pages in an application

You can modify the pages in an application by link:applications.md#specify-pages[mapping other pages] in the application descriptor, and/or link:applications.md#define-navigation[creating, moving, or deleting menus or menu options].
