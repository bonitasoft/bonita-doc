...
Therefore, such profiles will be suggested. Those created in the Bonita Applications will not, but you can still export them from the Applications and import them in the studio to get them in the suggested options.
