...
[.card.card-index]
--
xref:admin-application-overview.adoc[[.card-title]#Bonita Administrator application# [.card-body.card-content-overflow]#pass:q[The main user interface provided by Bonita]#]
--
