...
Bonita Studio contains all the elements needed to design and compile processes allowing entities of an organization to handle data in a standardized and traceable way. +
...
Bonita also comes with three more usefule applications:
