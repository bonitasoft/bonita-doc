...
* https://fr.bonitasoft.com/videos/user-centered-design-gage-du-succes-de-vos-projets-dautomatisation-des-processus-metiers[UIn French]
...
=== User Interfaces and Infrastructure setup
