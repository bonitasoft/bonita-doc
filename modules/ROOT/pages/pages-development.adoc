...
To view an example page, map the page to an xref:applications.adoc[application] so that you can view it in Bonita Portal. To view the source of an example, link:resource-management.md#export[export the custom page].
