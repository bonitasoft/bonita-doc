...
relationships will be loaded. +

[WARNING]
====
We strongly recommend to use the default *lazy* loading option. Indeed, when the composition and aggregation relationships go in deep levels vertically or horizontally, the eager loading option can have a huge impact on the platform performances, due to the additional data load and maintenance of the information in memory. +
