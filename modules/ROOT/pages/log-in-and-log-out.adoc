...
A user may receive an email with a link to start a case or do task in Bonita User Application, or a custom application.
...
The default application is the Bonita Application Directory. From there, the user can xref:navigation.adoc[navigate] to their other profiles. +
...
See also xref:bonita-bpm-applications-urls.adoc[Accessing Bonita Applications and forms by URL]
