...
A tenant can be created using the Java PlatformAPI (see the https://javadoc.bonitasoft.com/api/{javadocVersion}/com/bonitasoft/engine/api/PlatformAPI.html[Engine Javadoc]) or the xref:platform-api.adoc[platform REST API].
...
Use the https://javadoc.bonitasoft.com/api/{javadocVersion}/index.html[PlatformAPI] to perform operations on tenants.
