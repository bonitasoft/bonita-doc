...
*Instance* : when you start a process (through Applications, and the API) what actually happen is a creation of a new process instance based on the selected process definition. +
