...
*Instance* : when you start a process (in the Applications or through the API) what actually happen is a creation of a new process instance based on the selected process definition. +
