...
NOTE: The Docker environment package is not publicly distributed. To receive the package for your Bonita version, please open a request with https://customer.bonitasoft.com[Bonitasoft Support].
