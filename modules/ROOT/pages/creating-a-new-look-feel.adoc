...
Those old pages take into account the theme of your application. If you want to modify their style, we strongly suggest xref:theme-development.adoc[you change the theme]. +
