...
Since the xref:ROOT:portal-removal.adoc[removal of Portal in 2021.2], the Look & Feel was re-packaged in the bundle itself. You can find it in the `server/webapps/bonita/portal-theme` folder. For a reference about the contained files go to https://documentation.bonitasoft.com/bonita/2021.1/creating-a-new-look-feel[the previous version of Bonita]. +
