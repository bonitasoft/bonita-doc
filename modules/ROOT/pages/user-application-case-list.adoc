...
To know more about how to set an entity of the organization as the initiator of a case, go to the xref:actors.adoc[actors] page, or check the xref:user-process-list.adoc[User process list] page.
