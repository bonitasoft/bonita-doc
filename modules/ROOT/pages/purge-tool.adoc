...
The purge tool doesn't delete the documents stored in the DOCUMENT table. It will only remove the mapping between the archived cases and the document itself. If you want to purge the Document table, you will have to use the Engine API or REST API. See the xref:documents.adoc[documents page]. 
====
