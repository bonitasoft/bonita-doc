...
. If you do not already have one:
 ...
 .. xref:tomcat-bundle.adoc#configuration[Configure] it as needed
...
Make sure to xref:multi-tenancy-and-tenant-configuration.adoc#tenant_creation[set the right tenant admin username].
