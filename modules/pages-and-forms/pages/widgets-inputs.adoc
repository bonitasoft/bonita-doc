== Input widgets
:description: Ui-designer contains  different input to collect user input.
...
image::widgets/currency-input.png[currency-input]
...
image::widgets/text-area.png[text-area]
image::widgets/rich-text-area.png[rich-text-area]
...
image::widgets/autocomplete.png[autocomplete]
...
image::widgets/checkbox.png[checkbox]
...
image::widgets/checklist.png[checklist]
...
=== Date picker widget
image::widgets/datepicker.png[datepicker]
...
image::widgets/datetimepicker.png[datetimepicker]
...
image::widgets/upload.png[upload]
...
image::widgets/button.png[button]
...
image::widgets/savebutton.png[savebutton]
