...
image::widgets/page-rows-and-widgets.png[page-rows-and-widgets-palette]
...
image::widgets/fileviewer.png[fileviewer,align="left"]
...
image::widgets/rich-text-area.png[rich-text-area,align="left"]
...
image::widget_switch_mapping.png[widget_switch_mapping]
