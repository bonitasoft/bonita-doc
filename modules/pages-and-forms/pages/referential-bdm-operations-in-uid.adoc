...
This page describes how to design a page with the UI Designer that imports a CSV-formatted file containing referential xref:data:define-and-deploy-the-bdm.adoc[Business Data] into the BDM.
