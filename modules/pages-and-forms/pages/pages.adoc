...
Bonita Runtime comes with some provided pages to use in applications. They are wrapped pages developed in other technologies than Bonita UI Designer (AngularJS, Svelte). +
...
[#list_bonita_application_customizable_pages]
...
For all information about developing a custom page, visit xref:ROOT:pages-development.adoc[the dedicated documentation page].
