...
For more information about process, business data management, and contract, check out https://www.oreilly.com/library/view/designing-efficient-bpm/9781491924709/[*Designing Efficient BPM Applications: A Process-Based Guide for Beginners*].
