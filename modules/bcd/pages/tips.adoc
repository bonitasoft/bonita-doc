...
It uses the xref:build-run:build-application.adoc[Bonita Application Builder] and the xref:deployer.adoc[Bonita Application Deployer].
...
* you have cloned a Git repository as described in the xref:build-run:build-application.adoc[Bonita Application Builder] documentation
...
First, we build the Bonita repository as explained xref:build-run:build-application.adoc[here] 
