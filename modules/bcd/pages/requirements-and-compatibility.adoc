...
:description: Bonita CI/CD suite requirements and compatibility matrix
...
The Bonita CI/CD suite features (build and deploy) are implemented by two standalone Java CLIs (command line interface).
...
[TIP]
====
Bonita CI/CD suite uses the technical Id of the platform. xref:version-update:product-versioning.adoc#technical-id[You will find here the mapping between Bonita release and technical Id]
====
