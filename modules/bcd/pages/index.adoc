...
This section presents the overall concept, pleaserefer to the product documentation or contact Bonitasoft for implementation details and best practices.
...
image::CI_CD architecture-diagram-application-deployment.png[Bonita Continuous Delivery Capabilities]
