...
=== Full Deployment
For each new version, the platform and the application code are packaged together and redeployed as a whole. The package (image, bundle, etc.) is archived in a repository and installed on servers that don’t have the platform pre-installed.
