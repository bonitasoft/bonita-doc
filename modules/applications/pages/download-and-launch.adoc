...
Two environments are available: - `IMAGE_NAME` to override the Bonita UI Builder image name. (default is `{bonitasoft-docker-repository}/bonita-ui-builder:{bonita-ui-builder-latest-version}`)
