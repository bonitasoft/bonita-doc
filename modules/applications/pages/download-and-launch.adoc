...
== Prerequisites
* Docker installed
* Bonita started on the local machine
...
[TIP]
====
If encountering issues Windows and WSL, check our xref:applications:faq.adoc#_i_am_runing_bonita_with_windows_and_bonita_ui_builder_with_wsl_does_not_work[FAQ] .
====
