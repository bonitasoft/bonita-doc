...
Also, make sure the `token` value is identical to the value of the `slug` key found in the xref:package-and-deploy-your-application.adoc#_export_your_application[JSON export of the application]. If several `slug` keys are found in the JSON export, you should take the value of the first `slug` key.
--
