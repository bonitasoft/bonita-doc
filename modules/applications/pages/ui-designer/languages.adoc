...
:page-aliases: ROOT:languages.adoc, applications:languages.adoc
...
* Translation is performed by Ofelia or trusted partners
...
image:ui-designer/UI2021.1/select-language.png[Select language]
...
Instructions below explain how to add a language to the Bonita Runtime. Steps below involve using content created by Ofelia community and therefore not officially supported.
...
. Make sure you click on the "Toggle Hidden Files" button image:ui-designer/crowdin_toggle_hidden_files.png[Toggle hidden files button] to see already fully translated files.
