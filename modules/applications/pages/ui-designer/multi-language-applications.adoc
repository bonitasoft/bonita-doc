...
image:ui-designer/multi-language-applications/menu-widget.png[Menu-widget]
...
image:ui-designer/multi-language-applications/edit-localization.png[Edit-localization]
. The localization.json file shows four different sets of strings based on the languages available.
image:ui-designer/multi-language-applications/localization.png[Localization]
...
image:ui-designer/multi-language-applications/add-keys.png[Add-keys]
