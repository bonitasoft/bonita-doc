= Bonita Layout
:page-aliases: ROOT:bonita-layout.adoc, applications:bonita-layout.adoc
:description: Layout for the Bonita UI Designer Layout for the Bonita UI Designer

[NOTE]
====
For Subscription editions only. Test
====
...
You can customize this layout by following the xref:ROOT:customize-layouts.adoc[customize-layouts] steps.
