...
:page-aliases: ROOT:applicationCreation.adoc, ROOT:application-creation.adoc, applications:application-creation.adoc
...
image:ui-designer/applicationDescriptors/emptyApplicationFile_v3.png[Empty Application File] +
...
image:ui-designer/applicationDescriptors/applicationDescriptorEditor_v3.png[Application Descriptor Editor]
