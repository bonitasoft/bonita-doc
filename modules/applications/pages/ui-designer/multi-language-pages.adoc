...
:page-aliases: ROOT:multi-language-pages.adoc, applications:multi-language-pages.adoc
...
[source,json]
----
include::example$ui-designer/localization.json[]
----

You can xref:example$ui-designer/localization.json[download a copy of this `localization.json` file] for testing.
...
image:ui-designer/images-6_0/l10n-combined-previews.png[Multi-language page previews]
