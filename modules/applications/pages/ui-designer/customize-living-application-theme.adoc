...
:page-aliases: ROOT:customize-living-application-theme.adoc, applications:customize-living-application-theme.adoc
:description: This page explains how to create a theme project using Bonita Studio or the dedicated maven archetype.
...
== Create a custom theme with Bonita Studio

Bonita Studio allows you to create a theme directly in your Bonita Project. See xref:software-extensibility:extensions-sdk.adoc#servers[more details here].

== Create an independent theme project using the maven archetype
