...
:page-aliases: theme-development.adoc
...
Themes are xref:resource-management.adoc[added, exported, edited, and deleted] as resources in Bonita Administrator Application. +
