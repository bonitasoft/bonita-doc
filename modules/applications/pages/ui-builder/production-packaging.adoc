...
* Start a container (`bonita-app`) with the Bonita Application (containing your Bonita project) image 
* Start a container (`bonita-ui-builder`) with Bonita UI Builder and your UIB applications 
