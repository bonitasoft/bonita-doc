...
* Start a container (`bonita-app`) with the Bonita Application image (containing your Bonita project) 
* Start a container (`bonita-ui-builder`) with the Bonita UI Builder runtime and applications 
* Start a container (`bonita-ui-proxy`) with a reverse proxy to link the two previous containers 
