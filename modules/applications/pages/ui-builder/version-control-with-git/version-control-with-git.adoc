...
[WARNING]
====
Connecting to the main branch of a Git repository should be avoided.
Indeed, the Auto Commit feature ensures that changes related to a Bonita UI Builder version upgrade are automatically committed.
See xref:applications:git-settings.adoc#_disable_auto_commit[Disable Auto-Commit] for details.
====
...
During development phase, you can access the UI Builder application from the UI Builder workspace using the default URL (e.g `http://localhost/`).
--
