...
Yes, you can use Bonita UI Builder offline. You can perform all your tests and interact with your Bonita projects offline. An internet connexion is however required to download Bonita UI Builder.
