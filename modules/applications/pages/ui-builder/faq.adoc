...
Check which container is using the same name and delete it before starting UI Builder or eventually, modify `docker-compose.yml` file to avoid name conflict. +
