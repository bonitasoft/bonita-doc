...
[NOTE]
====
This documentation corresponds to the latest version of Bonita UI Builder, which is pass:a[{bonita-ui-builder-version}].
See the xref:ui-builder/ui-builder-release-notes.adoc[release notes] for more information.
====


== Bonita UI Builder

Bonita UI Builder is a development environment made for designing all kinds of interfaces, pages, forms, for your applications.
...
Bonita UI Builder is a standalone product available as a custom Docker image, which can be downloaded from the Bonitasoft JFrog repository. It also requires a 2024.3 Enterprise version of Bonita (or any later version) to work.
...
If you haven’t subscribed to a Scale or Access plan yet, please https://www.bonitasoft.com/contact-us[get in touch] with our sales team to start your journey today!
