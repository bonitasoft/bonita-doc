...
[source,bash]
----
curl 'http://localhost/uib/api/v1/applications/import' \
...
[source,bash]
----
curl 'http://localhost/uib/api/v1/applications/import-bulk' \
  --header 'x-requested-by: Appsmith' \
  --header 'Cookie: X-Bonita-API-Token=xxxxx ; JSESSIONID=xxxxx' \
...
[source,bash]
----
curl 'http://localhost/uib/api/v1/applications/all' \
  --header 'x-requested-by: Appsmith' \
  --header 'Cookie: X-Bonita-API-Token=xxxxx ; JSESSIONID=xxxxx'
----
