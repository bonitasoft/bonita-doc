...
* **Method**: POST
* **URL**: `/uib/api/v1/workspaces/import`
* **Headers**:
...
[source,bash]
----
curl 'http://localhost/uib/api/v1/workspaces/import' \
...
* **Method**: POST
* **URL**: `/uib/api/v1/workspaces/import-bulk`
* **Headers**:
** `x-requested-by: Appsmith`
...
[source,bash]
----
curl 'http://localhost/uib/api/v1/workspaces/import-bulk' \
  --header 'x-requested-by: Appsmith' \
  --header 'Cookie: X-Bonita-API-Token=xxxxx ; JSESSIONID=xxxxx' \
...
* **Method**: DELETE
* **URL**: `/uib/api/v1/workspaces/clean`
* **Headers**:
** `x-requested-by: Appsmith`
...
[source,bash]
----
curl 'http://localhost/uib/api/v1/workspaces/clean' \
  --header 'x-requested-by: Appsmith' \
  --header 'Cookie: X-Bonita-API-Token=xxxxx ; JSESSIONID=xxxxx'
----
