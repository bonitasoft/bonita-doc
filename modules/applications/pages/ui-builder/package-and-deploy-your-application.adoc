...
=== Setup permissions for your application

You can now xref:ui-builder/how-to-declare-permissions-for-rest-api-request.adoc[declare permissions] for your application from Bonita Platform.
