...
image:ui-builder/advanced-app/export-all-application.png[Export all application]
...
With an integration in a Bonita Studio, the `workspace` folder is automatically created in the project folder. You need to store the exported application(s) in this folder.

[NOTE]
====
By default, the `workspace` folder in a Bonita Studio project, is store in: `<project-workspace-path>/app/.settings/org.bonitasoft.studio.common.repository/uib/workspace`
====
