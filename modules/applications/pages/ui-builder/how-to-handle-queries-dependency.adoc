...
Go to the `Queries` tab and create a first query that will fetch the users:
...
Then, create a second query that will fetch the manager of the first user:
...
To solve this issue, we will create a JS Object that will run the queries in the right order.
