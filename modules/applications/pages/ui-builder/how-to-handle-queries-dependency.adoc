...
Since you want to get this information on a page load, you *may* have an issue if the second API call is executed *before* the first one is done.
...
== 4. Disable the running on a page load for the queries
