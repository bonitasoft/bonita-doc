...
[.card.card-index]
--
xref:how-to-declare-permissions-for-rest-api-request.adoc[[.card-title]#Grant permissions to perform request to Bonita REST API. # [.card-body.card-content-overflow]#pass:q[Learn how to grand permissions for pages to perform requests to Bonita REST API.]#]
--
