...
[.card.card-index]
--
xref:how-to-handle-queries-dependency.adoc[[.card-title]#How to handle dependencies between queries# [.card-body.card-content-overflow]#pass:q[Learn how to handle dependencies between queries that run on page load]#]
--
