...
* Some Appsmith features have been activated
  * Static URLS: TODO add link to guides when available (see PR #3243 for more details)
  * Page size dimension: appsmith.ui object, useful for mobile development. TODO add link to guides when available (see PR #xxx for more details)
