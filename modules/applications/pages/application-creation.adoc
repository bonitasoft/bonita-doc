...
It accounts for an additional step to ease the management of xref:ROOT:applications.adoc[Living Applications] in Bonita, since our objective is to offer a unique application deployment artifact, managed from the Studio. +
