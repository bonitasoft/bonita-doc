...
You may also encounter this issue if you use a xref:applications:customize-layouts.adoc[customized layout] instead of the official one. In that case, update your custom layout by re-applying your modifications to the latest layout / application directory version that implements the improvements for Application Links.
