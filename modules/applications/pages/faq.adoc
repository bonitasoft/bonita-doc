...
=== I am runing Bonita with Windows and Bonita UI Builder with WSL does not work.

When using Windows and WSL, the localhost URLs do not have the same IP address.

* From Windows, localhost is automatically redirecte to Linux WSL when needed.
