= Update overview
:page-aliases:  version-update:update-studio.adoc, version-update:update-overview.adoc, ROOT:update-overview.adoc, ROOT:migration-overview.adoc, ROOT:migrate-from-an-earlier-version-of-bonita-bpm.adoc, ROOT:migrate-from-an-earlier-version-of-bonita.adoc
