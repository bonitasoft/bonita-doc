...
** By downloading those dependencies from the {cscCustomerServices}[Customer Service Center] (Maven repository) and copying them into their local Maven repository
