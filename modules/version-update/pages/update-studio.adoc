...
This allows others contributors of the project to keep using an older Studio version without needing to install additional dependencies. +
...
** By downloading those dependencies from the https://customer.bonitasoft.com[Customer Service Center] (Maven repository) and copying its content into their local Maven repository
