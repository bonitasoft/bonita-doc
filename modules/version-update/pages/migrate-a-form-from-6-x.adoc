...
. BDM: create your xref:ROOT:define-and-deploy-the-bdm.adoc[business data model]. If you already have a BDM from 6.x, no change is needed.
...
. Contracts: define xref:ROOT:contracts-and-contexts.adoc[contracts] based on your business data, for process instantiation and for each human task.
