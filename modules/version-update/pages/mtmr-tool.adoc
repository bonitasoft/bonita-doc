...
WARNING: xref:2022.2@ROOT:multi-tenancy-and-tenant-configuration.adoc[Multi-tenancy] has been removed starting from Bonita 2023.1 (technical version 7.16). *If you are using multi-tenancy, you will have to run this conversion tool before updating to Bonita 2023.1.*
...
In order to prepare the technical conversion from multi-tenancy to multi-runtime, Bonitasoft developed a dedicated tool - Multi-tenant to multi-runtime conversion tool (MT2MR tool) - available for download https://customer.bonitasoft.com/download/request[on Bonita Customer Portal].
