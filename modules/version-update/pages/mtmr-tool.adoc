...
In order to prepare the technical conversion from multi-tenancy to multi-runtime, Bonitasoft developped a dedicated tool - Multi-tenant to multi-runtime conversion tool (MT2MR tool) - available for download xref:https://customer.bonitasoft.com/download/request[on Bonita Customer Portal]. 
