...
:page-aliases: migrate-from-an-earlier-version-of-bonita-bpm.adoc, ROOT:migrate-from-an-earlier-version-of-bonita.adoc
...
To update to Bonita 7.9 or a greater version from an earlier version than Oracle 12c (12.2.x.y), see xref:migrate-from-an-earlier-version-of-bonita-bpm.adoc#oracle12[Updating to Bonita 7.9 or greater versions using Oracle].
