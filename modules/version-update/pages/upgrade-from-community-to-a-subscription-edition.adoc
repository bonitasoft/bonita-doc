...
At this stage, the bonita platform is functional, but missing the (subscription version) provided administrator application. You will need to import it manually to use its features. To do so:
