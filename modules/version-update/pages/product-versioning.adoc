...
If the artifact is incompatible, then either Bonita Studio migrates the artifact (when the model version is lower than the Bonita Studio version), or you will have to update your studio to a compatible version. +
