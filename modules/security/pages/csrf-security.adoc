= CSRF security
:page-aliases: ROOT:csrf-security.adoc
...
xref:identity:user-authentication-overview.adoc[User authentication overview]
...
1) xref:ROOT:resource-management.adoc#modify[Edit the existing page] by uploading the new one.
