...
Starting from Bonita 2026.1, Java Security Policy is enabled by default in Docker deployments using the `PRO_GRADE=true` environment variable.
...
When upgrading to Bonita 2026.1 or later, be aware of the following:
