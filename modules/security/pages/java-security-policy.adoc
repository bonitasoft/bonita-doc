...
Starting from Bonita 2024.1-u9, Java Security Policy is enabled by default in Docker deployments using the `PRO_GRADE=true` environment variable.
...
When upgrading to Bonita 2024.1-u9 or later, be aware of the following:
