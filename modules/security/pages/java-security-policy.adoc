...
Starting from Bonita 2024.2-u7, Java Security Policy is enabled by default in Docker deployments using the `PRO_GRADE=true` environment variable.
...
When upgrading to Bonita 2024.2-u7 or later, be aware of the following:
