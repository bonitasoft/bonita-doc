...
It is very much recommended to change those values. It's done by overriding the following environment properties:
...
It's typically done when staring up the Bonita docker image:
...
Alternatively, these properties can be all centralized with others in a bonita.env file
