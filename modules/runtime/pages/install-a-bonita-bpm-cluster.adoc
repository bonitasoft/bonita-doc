...
[NOTE]
====
The https://www.google.com/search?q=Hibernate+L2+cache[Hibernate L2 cache] will be automatically disabled in cluster, leading to lower performance and more frequent database accesses.
====
