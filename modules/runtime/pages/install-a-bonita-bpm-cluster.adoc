...
*Symptom*: +
I regularly get this warning message when 2 or more nodes are started in cluster:
...
It is a good idea to have the database server system time synchronized too. +
Synchronize the system times of all nodes and restart application servers.
