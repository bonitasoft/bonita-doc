...
open source library
* uses a maximum of 20 connections. To change this value, refer to the page xref:ROOT:configure-client-of-bonita-bpm-engine.adoc[Configure connection to Bonita Engine].
...
The work service is configured in xref:ROOT:bonita-platform-setup.adoc[`bonita-tenant-community-custom.properties`].
...
The *work execution delay* is configured in xref:ROOT:BonitaBPM_platform_setup.adoc[`bonita-tenant-community-custom.properties`].
