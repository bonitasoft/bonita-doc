...
The Bonita platform has a technical administrator, with a specific username and password. The technical administrator was formerly known as the tenant technical user.
