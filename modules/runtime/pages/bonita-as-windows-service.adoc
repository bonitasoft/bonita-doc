...
* *_Copy_* the application %TOMCAT_BUNDLE%/server/webapps/bonita to %TOMCAT_INSTALL_FOLDER%/webapps
...
* Connect with the technical administrator (default install/install) and do some tests:
 ** Add an organization.
