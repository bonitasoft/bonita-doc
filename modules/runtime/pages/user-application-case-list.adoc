...
:description: This page explains what a user with the _User_ profile can see and do about cases (the process instances) in xref:ROOT:user-application-overview.adoc[Bonita User Application].
...
To know more about how to set an entity of the organization as the initiator of a case, go to the xref:ROOT:actors.adoc[actors] page, or check the link:user-process-list[User process list] page.
...
To know more about how to implement search keys, go to the xref:ROOT:define-a-search-index.adoc[search keys] page.
