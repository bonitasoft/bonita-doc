...
To be able to deploy or redeploy a BDM, the *maintenance mode of this tenant must be started* first.
...
After (re-)deploying the BDM, the maintenance mode must be ended to be able to use
