...
Execution date for timer of type *DATE* or *DURATION* (not *CYCLE*) can be changed using the Then the connector can be manually be replayed using the {openApiUrl}/{openApiLatestVersion}/#tag/TimerEventTrigger[BPM Rest API]
...
Check xref:ROOT:performance-tuning.adoc#cron[this page] to fine tune Quartz performance.
