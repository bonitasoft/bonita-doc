...
[.card.card-index]
--
xref:runtime:configuring-bonita-with-properties.adoc[[.card-title]#Bonita configurability# [.card-body.card-content-overflow]#pass:q[Know how Bonita runtime can be configured through properties (database, Java System properties, environment variables)]#]
--
