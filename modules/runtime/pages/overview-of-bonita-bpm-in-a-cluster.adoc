...
When migration to a different release of the Bonita Runtime, the database also needs to be migrated. See xref:migrate-from-an-earlier-version-of-bonita.adoc#migrateCluster[here]
