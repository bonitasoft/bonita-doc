...
:page-aliases: ROOT:configurable-archive.adoc
...
To configure the archiving strategy, edit the file xref:runtime:bonita-platform-setup.adoc[`bonita-tenant-sp-custom.properties`] and specify the items that you want archived.
