...
To configure the archiving strategy, edit the file xref:bonita-platform-setup.adoc[`bonita-tenant-sp-custom.properties`] and specify the items that you want archived.
