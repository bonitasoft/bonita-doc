...
In addition, there is an incident file <BUNDLE_HOME>/logs/incident.log that is used as a last resort to record an error that cannot be handled, such as failure to access the database.
--
