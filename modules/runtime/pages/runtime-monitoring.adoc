...
Retrieve xref:bonita-platform-setup.adoc#update_platform_conf[current configuration] by running:
...
<<<<<<< HEAD
Then xref:bonita-platform-setup.adoc#update_platform_conf[push your configuration changes] to database:
=======
Then xref:ROOT:BonitaBPM_platform_setup.adoc#update_platform_conf[push your configuration changes] to database:
>>>>>>> 187a556f53880b07b19092b89569b23a866eb244
