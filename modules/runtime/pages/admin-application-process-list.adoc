...
:description: This page explains what a user with the _Administrator_ profile can see and do about processes in link:admin-application-overview[Bonita Administrator Application].
...
All of what follows belong to the xref:ROOT:live-update.adoc[Live update feature] and are only available in for the Enterprise, Performance, and Efficiency editions.
