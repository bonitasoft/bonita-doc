...
Reminder: do not create a user with the same login and password as the xref:ROOT:first-steps-after-setup.adoc[platform administrator nor the technical administrator].
