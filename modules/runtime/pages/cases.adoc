...
The case details page displays general information about the case as well as counters of done, pending and faled flow nodes for the case and its possible child cases (started by call activities).
