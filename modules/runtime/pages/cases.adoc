...
The case details page displays general information about the case as well as counters of tasks for the case and its possible child cases (started by call activities).
