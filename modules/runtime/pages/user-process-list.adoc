...
image:UI2021.1/user_process_list.png[User Process list]
...
image:UI2021.1/Actor-mapping.png[Actor mapping]

In the Pool properties, here is how to set an actor as the initiator.

image:UI2021.1/Set-as-initiator.png[Set an actor as the process initiator]
