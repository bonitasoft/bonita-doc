...
By default, some promotion messages are displayed in some Admin application page. To disable them, follow one of these steps:
...
.Setting the property in_bonita-platform-sp-custom.properties
[source, properties]
----
# Promotion
