...
// TODO validate that the link has been updated in all pages
Copy your request key and go to the https://csc.bonitacloud.bonitasoft.com/apps/CustomerServices/licenses[Customer Service Center license request] page. +
