...
Your contract with Ofelia specifies the details of the subscription you have purchased, including the edition, and case limit for case-counter licensing. A license matching the subscription details is generated on request.
...
Copy your request key and go to the {cscLicenseUrl}[Customer Service Center license request] page. +
