...
. Create a new xref:ROOT:layout-development.adoc[layout] and make it available like a page (UI Designer or *Resources* if created in another IDE)
...
. Create a new xref:ROOT:customize-living-application-theme.adoc[theme] 
