...
This living application is not installed by default in the Bonita tomcat bundle and in Bonita docker image in application mode.footnote:adminApplication[In the deprecated platform mode, this application still be embedded by default.]
