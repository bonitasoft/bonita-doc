...
:description: Sometimes it is useful to understand what is currently happening in the platform, in particular for work execution, see xref:ROOT:execution-sequence-states-and-transactions.adoc[Work service mechanism].

Sometimes it is useful to understand what is currently happening in the platform, in particular for work execution, see xref:ROOT:execution-sequence-states-and-transactions.adoc[Work service mechanism].
