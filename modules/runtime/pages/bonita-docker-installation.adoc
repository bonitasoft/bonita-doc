...
* Play the migration script on your Bonita database see xref:migrate-from-an-earlier-version-of-bonita.adoc#migrate[migrate the platform from an earlier version of Bonita].
...
See xref:bonita-platform-setup.adoc#update_platform_conf[setup tool page] for more information.
