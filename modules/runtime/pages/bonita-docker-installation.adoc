...
xref:runtime:bonita-repository-access.adoc#docker[Docker section of Access to Bonita Artifact Repository] will give you more information to connect with these credentials.
====
...
* Information on how to access the Bonita Artifact Repository can be found xref:runtime:bonita-repository-access.adoc#docker[here].
