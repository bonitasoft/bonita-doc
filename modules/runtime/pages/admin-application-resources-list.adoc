...
:description: This page defines the term "Resources" and explains what a user with the _Administrator_ profile can see and do about resources in link:admin-application-overview[Bonita Administrator Application].
...
You can find examples of the default resources in xref:ROOT:BonitaBPM_platform_setup.adoc[`resources-permissions-mapping.properties`].
...
The Administrator can xref:ROOT:live-update.adoc[Live Update] the resource list:
