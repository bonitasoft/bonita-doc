...
This living application is not installed by default in the Bonita tomcat bundle and in Bonita docker image in application.footnote:userApplication[In the deprecated platform mode, this living application is still embedded by default.]
