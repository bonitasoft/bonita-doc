...
| 19c (19.3.0.0.0) & 23-ai (23.9.0.0) (see note 5)
...
. Check out the requirements for Bonita UI Builder in the dedicated
xref:{bonitaUiBuilderVersion}@ui-builder::faq.adoc[dedicated FAQ]
