...
[source,shell]
----
DATABASE_PASSWORD=secret ./bin/bonita-purge list --older-than 6m
----
====
...
[source,shell]
----
./bin/bonita-purge list --older-than 6m
----
...
[source,shell]
----
./bin/bonita-purge.bat list --older-than 6m
----
====
...
[source,shell]
----
./bin/bonita-purge delete --older-than 6m
----
...
[source,shell]
----
./bin/bonita-purge.bat delete --older-than 6m
----
====
...
[source,shell]
----
./bin/bonita-purge delete --older-than 6m --process-definition-id 1234567890
----
...
[source,shell]
----
./bin/bonita-purge.bat delete --older-than 6m --process-definition-id 1234567890
----
====
...
[source,shell]
----
./bin/bonita-purge delete --before-date 1656979200000
----
...
[source,shell]
----
./bin/bonita-purge.bat delete --before-date 1656979200000
----
====
...
[source,shell]
----
./bin/bonita-purge delete-fileinput-content
----
...
[source,shell]
----
./bin/bonita-purge.bat delete-fileinput-content
----
====
