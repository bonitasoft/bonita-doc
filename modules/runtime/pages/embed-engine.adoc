...
:description: Artifacts allow to start an embedded engine in your application.
...
All other configuration can be customized using the standard bonita configuration tool xref:runtime:bonita-platform-setup.adoc[Platform setup tool]
