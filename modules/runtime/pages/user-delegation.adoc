...
When another user has an active delegation to you, their tasks appear under *Tasks delegated to me*, separately from your own task list. Only tasks from the whitelisted processes and its subprocesses, within an active period, are shown.
