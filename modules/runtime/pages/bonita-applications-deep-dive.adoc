...
[.card-section]
== Bonita Applications
Ofelia developers develop Bonita using Bonita. +
...
* Generic applications. They are fully functional, can be added from the Marketplace or imported for customization in your Bonita project. It is also possible to deleted them if not useful for your application:
    ** Administrator
    ** User
* Bonita applications. They are developed by Ofelia and delivered as independent applications. You can add them from the Marketplace to include then in your application:
    ** Reporting App
