...
User, Administrator and Reporting App applications are not embedded by default in application mode.footnote:liveupdate[When using the deprecated platform mode, this application is embedded by default.]
