...
[.card.card-index]
--
image::images/images-6_0/row-over.png[row toolbar] xref:ROOT:application-directory.adoc[[.card-title]#Application directory# [.card-body.card-content-overflow]#pass:q[The logged user's catalog of applications... and more]#]
--
