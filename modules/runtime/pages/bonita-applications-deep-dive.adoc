...
[.card.card-index]
--
xref:ROOT:application-directory.adoc[[.card-title]#image::images/images-6_0/row-over.png[row toolbar]
Application directory# [.card-body.card-content-overflow]#pass:q[The logged user's catalog of applications... and more]#]
--
