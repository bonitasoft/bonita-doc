...
* xref:ROOT:rest-api-authorization.adoc[REST API extension permissions]
...
In development, the creation and edition of profiles is done through the xref:ROOT:profileCreation.adoc[profile editor] in Bonita Studio. +
