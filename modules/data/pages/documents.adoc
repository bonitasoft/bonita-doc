...
Although documents stand for business information to share / update / upload / download / delete / store within the life time of a process instance, they are not part of the xref:ROOT:define-and-deploy-the-bdm.adoc[Business Data Model] in Bonita. +
