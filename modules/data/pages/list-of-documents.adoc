...
:page-aliases: ROOT:list-of-documents.adoc
...
[WARNING]
====
This tutorial assume that you are already familiar with Bonita. If not you might want to read the xref:bonita-overview:what-is-bonita-index.adoc[Getting started] first.
====
...
image:documentValidationProcess.png[Validation process]
