...
image:images-6_0/variables_scope.png[Scope of variables]
...
** Docker image
*** Add the following environment variable when starting the container: `-e JDK_JAVA_OPTIONS=--add-opens=java.xml/com.sun.org.apache.xerces.internal.jaxp.datatype=ALL-UNNAMED`
