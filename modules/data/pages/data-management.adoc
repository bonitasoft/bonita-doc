...
TODO add a link to a new dedicated how-to page in the "pages and forms how-tos" 

In this new page, explain how to do bulk import. Do not use the file upload widget, but rather the BDM import feature.
