...
Discover how to explore the xref:define-business-data-model.adoc[Business Data Model] (BDM) objects in the UI Designer, and how to use it to create user interfaces and variables.
