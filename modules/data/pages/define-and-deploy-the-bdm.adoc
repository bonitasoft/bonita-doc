...
Lazy loading, by contrast, retrieves only the parent object. When accessing one of it's child object, a new SELECT statement will be generated.
...
The tradeoff between those two options is execution time vs memory consumtion.
====
