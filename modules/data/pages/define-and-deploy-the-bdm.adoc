...
Based on your tecnical analysis, if you still decide to use *EAGER* design pattern, *we strongly recommend thorough testing with a test dataset having the size of your production's expected dataset*.
====
