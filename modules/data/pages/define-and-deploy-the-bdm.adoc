...
[WARNING]
====
Before deploying the business data model, you must xref:ROOT:platform-maintenance-mode.adoc[Enable] the maintenance mode, so that the update can be performed without affecting ongoing processes.
====
