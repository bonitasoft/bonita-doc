...
== Add Bonita Repository Manager (Subscription editions only)

Please refer to the page xref:software-extensibility:bonita-repository-access.adoc[Access to Bonita Repository Manager] to get the information needed to set up the access to Bonita Repository Manager. Then use the steps described above to add Bonita Repository Manager into your Bonita Studio.
