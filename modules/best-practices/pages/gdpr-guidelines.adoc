...
Ofelia acts as a subcontractor, within the meaning of Article 4 of the GDPR, in the context of its https://www
.bonitasoft.com/bonita-cloud[Bonita Cloud offer]. As such, Ofelia is required to host the data uploaded by its customers on the Bonita Cloud platform, when they use the services.
