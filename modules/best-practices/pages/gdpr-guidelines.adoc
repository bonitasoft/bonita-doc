= GDPR Design guide
:description: This page describes how data is managed by Ofelia, depending on the Edition you are using.
...
Ofelia acts as a subcontractor, within the meaning of Article 4 of the GDPR, in the context of its https://www.bonitasoft.com/bonita-cloud[Bonita Cloud offer]. As such, Ofelia is required to host the data uploaded by its customers on the Bonita Cloud platform, when they use the services.

When the Bonita Platform is installed directly on the clients' servers located on their premises ("on-premise" installation), Ofelia does not access the personal data processed via its software.
Access to data may however be granted to Ofelia, even in the case of an "on-premise" installation on an ad-hoc basis and only within the contractual Support service or https://www.ofelia.com/customer-services[Professional service].

|===
| | On-premise (Community and Enterprise) | Cloud

| Backups
| Backups are managed by you. It is highly recommended to xref:version-update:update-with-update-tool.adoc[backup your database] before launching an update procedure. Ofelia provides a xref:runtime:back-up-bonita-bpm-platform.adoc[procedure] to help you back up your Bonita runtime.
...
| Ofelia will store 15 days of back up for the production runtimes. This retention period can be increased upon customer request.

| Restoration
| Restorations are managed by you. Please note that the restoration procedure also depends on your database.
| Data restorations are done through a request and may result in scheduled maintenance. The service includes a restore to the latest backup. Ofelia is not responsible for the functional impacts of the rollback.
...
Please note that Ofelia has *ISO 27001 certification* for its Bonita Cloud information security and Bonita Cloud customer development, operations, and support.
...
Ofelia’s ISO 27001 certification is the result of a successful audit of the company’s cloud security practices by Bureau Veritas Certification, the world leader of certification.
