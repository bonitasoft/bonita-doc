...
image:doc-generation/generate_doc_menu.png[Generate documentation]
...
As a PDF file thanks to the image:doc-generation/pdfIcon.png[pdf export button] button

image:doc-generation/export_as_pdf.png[pdf export button]

=== Export as HTML

As an HTML document thanks to the image:doc-generation/previewHTML.png[Open in external browser] button.
...
There are other solutions to process AsciiDoc documents using https://asciidoctor.org/docs/asciidoctor-maven-plugin/[Maven] or https://asciidoctor.org/docs/asciidoctor-gradle-plugin/[Gradle] plugins.
...
image::doc-generation/github_preview.png[GitHub preview]
