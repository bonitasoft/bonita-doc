...
. To configure word-based search, using xref:bonita-platform-setup.adoc[the setup tool],
...
. For each object you be excluded from word-based search,  using xref:bonita-platform-setup.adoc[the setup tool],
