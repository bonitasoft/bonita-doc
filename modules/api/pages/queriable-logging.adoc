...
The Bonita Engine stores information in the queriable log. The information in the log is accessible using the {javadocUrl}/api/{javadocVersion}/index.html[LogAPI].
