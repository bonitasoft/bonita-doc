= Manage a process
:page-aliases: ROOT:manage-a-process.adoc
:description: This example shows you how to get a list of the deployed processes.
...
(attention, this user cannot be the technical administrator):
