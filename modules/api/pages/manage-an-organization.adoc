...
:page-aliases: ROOT:manage-an-organization.adoc
:description: Examples on how to import / read / edit / delete organizations through Bonita java API's.
...
The structure of the XML file is defined in an xref:identity:organization-overview.adoc[XSD file].
