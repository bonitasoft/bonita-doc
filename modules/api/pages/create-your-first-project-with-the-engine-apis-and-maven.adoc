...
* LoginAPI: Manages the login. Using this API you can obtain an APISession, which is required for access to the APIs, such as the IdentityAPI and the ProcessAPI.
