...
This way of creating a case using this method will only work for processes in which no contract is defined. To instantiate a process with a contract, check the <<actors-process-connectors-api.adoc#start-a-process-using-an-instantiation-contract,process instantiation resource documentation>>.
...
See <<actors-process-connectors-api.adoc#start-a-process-using-an-instantiation-contract,Start a process using an instantiation contract>> for usage.
====
