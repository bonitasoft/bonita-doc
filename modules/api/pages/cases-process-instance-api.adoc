...
Retrieve information about the flow nodes of the case identified by the given ID. This feature is available in Enterprise, Performance, Efficiency, and Teamwork editions.
