...
Please read the [Maven deploy plugin](https://maven.apache.org/plugins/maven-deploy-plugin/usage.html) instruction to configure your project for publication.
