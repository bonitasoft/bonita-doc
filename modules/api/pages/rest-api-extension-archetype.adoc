...
Please read the https://maven.apache.org/plugins/maven-deploy-plugin/usage.html[Maven deploy plugin^] instruction to configure your project for publication.
