...
* Edit `platform_conf/current/tenant_portal/custom-permissions-mapping.properties`.
...
Another REST API Extensions example with SQL data source is available on https://community.ofelia.com/t/data-source-rest-api-extension/26157[Ofelia Community]. This example shows how to execute SQL queries on a external database.


== Create a REST API Extension with Bonita Studio

Bonita Studio allows you to create a REST API Extension directly in your Bonita Project. See xref:software-extensibility:extensions-sdk.adoc#servers[more details here].

== Create an independant REST API Extension from the Maven Archetype
