= REST API System API
:page-aliases: ROOT:system-api.adoc
:description: Get information on the current session and on localisation/translation.
...
`GET`
* *Data Params* +
xref:api:rest-api-overview.adoc#resource_search[Standard search parameters] are available. +
