...
You can configure the connection to the engine directly using `org.bonitasoft.engine.util.APITypeManager`, please refer to the {javadocUrl}/api/{javadocVersion}/org/bonitasoft/engine/util/APITypeManager.html[Javadoc].
...
Deprecated, use the programmatic way instead, see {javaDocUrl}/api/{javadocVersion}/org/bonitasoft/engine/util/APITypeManager.html[APITypeManager].
====
