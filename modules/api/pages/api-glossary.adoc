...
:page-aliases: ROOT:api-glossary.adoc
...
* on the engine side, the {javadocUrl}/api/{javadocVersion}/index.html[Javadoc] page
* on the web site, the xref:ROOT:rest-api-overview.adoc[REST API page] page
