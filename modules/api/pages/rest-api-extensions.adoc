...
To use the project BDM `model` artifact you can refer to the xref:data:define-and-deploy-the-bdm.adoc#generated-java-dependencies[Generated java dependencies, window="blank"] section.
