...
In this example, we are going to create a connector to communicate with the https://swapi.py4e.com/[Star Wars API]. It will take in input a Star Wars character name, and will return details on this character. +
...
* https://spockframework.org/[Spock, window="_blank"]: __A test framework for Groovy applications__
* https://square.github.io/retrofit/[Retrofit, window="_blank"]: __A library which allows to create typed HTTP clients__

[NOTE]
====
While we recommend you to follow the step-by-step instructions, a Git repository containing the final solution is available on the Ofelia-Community GitHub: https://github.com/Bonitasoft-Community/bonita-connector-starwars[bonita-connector-starwars].
====
...
<input mandatory="true" name="url" type="java.lang.String" defaultValue="https://swapi.py4e.com/"/>
----
...
class StarWarsServiceTest extends Specification {
    ...
    def should_retrieve_luke_data_using_retrofit() {
        ...
        def service = ConnectorStarWars.createService(httpClient, "https://swapi.py4e.com/")
...
[#publish_connector_to_gh_packages]
