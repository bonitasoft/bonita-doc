...
[TIP]
====
Bonita Studio embbed a user interface to easily configure maven and encrypt passwords. See xref:ROOT:configure-maven.adoc[Configure Maven using Bonita Studio].
====
