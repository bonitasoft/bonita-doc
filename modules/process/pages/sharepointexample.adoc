...
Go to Entra ID (formerly Azure Active Directory) and choose App registrations. Create a New registration, provide a new name for your application and select the account type.
...
image:graphexplorer.jpg[Graph Explorer]
