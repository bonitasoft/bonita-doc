...
[source,groovy]
----
https://login.microsoftonline.com/' + sharepointAccount +'/oauth2/v2.0/token
----
where sharepointAccount should contain your account name (such as abcdef.microsoft.com).
