...
After deployment, depending on the Bonita edition that you are using, you can xref:ROOT:live-update.adoc[update the process configuration in production] for some aspects of the process.
