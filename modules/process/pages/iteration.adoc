= Iteration
:page-aliases: ROOT:iteration.adoc
:description: Iteration is used in Bonita when you need to perform a task multiple times.
...
image::images-6_0/multi_inst.png[Multi-instantiation]
...
image::images-6_0/loop_testBefore.png[Looping with Test Before]

image::images-6_0/loop_testAfter.png[Looping with Test After]
