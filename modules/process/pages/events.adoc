...
image::images-6_0/cron_timer_cycle.png[Example of defining a cycle with cron]

=== Example: Using a script to specify a time or date

image::images-6_0/exp_ed_date_example.png[Example of defining a date with a script in the expression editor]
