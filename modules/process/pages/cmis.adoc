 ...
 ** RepositoryService, for example _++https://localhost:12345/alfresco/cmis/RepositoryService?wsdl++_
 ** RepositoryService endpoint
 ** ObjectService, for example _++https://localhost:12345/alfresco/cmis/ObjectService?wsdl++_
...
* URL: _++http://localhost:8080/alfresco/api/-default-/public/cmis/versions/1.1/atom/++_
* Click *_Next_*.
