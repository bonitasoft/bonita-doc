...
:description: This page explains how to create and test custom connectors using the provided maven archetype or Bonita Studio.
...
== Create a custom connector with Bonita Studio
...
== Create an independent custom connector from the Maven Archetype
...
The entry point of the implementation sources must either extend the {javadocUrl}/api/{javadocVersion}/org/bonitasoft/engine/connector/AbstractConnector.html[__AbstractConnector__, window="_blank"] class
or implement {javadocUrl}/api/{javadocVersion}/org/bonitasoft/engine/connector/Connector.html[__Connector__, window="_blank"] interface.
