...
In order to define the candidates of a user task instance Bonita offers two alternatives: actor and xref:ROOT:actor-filtering.adoc[actor filters].
...
[NOTE]
====
To use actor filters in your processes, you first need to import the corresponding extensions from the xref:ROOT:managing_extension_studio.adoc[extension view].
====
