...
public class ProcessIT {
    ...
    @Test
    public void should_create_a_tyrannosaurus(BonitaTestToolkit toolkit) throws Exception { <2>
        ...
        BonitaAssertions.assertThat(processInstance).containsPendingTasks("CreateDinosaur"); <7>
