...
It is possible to make the connector fail on 5xx or 4xx response satus codes (with exclusion on specific codes).
The request can alos be replayed when it fails on 5xx or specific response satus codes.
