...
All object DAO are injected at runtime in Groovy script expression or can be retrieved using javadocUrl/api/{javadocVersion}/org/bonitasoft/engine/api/APIClient.html#getDAO-java.lang.Class-[APIClient#getDAO]
