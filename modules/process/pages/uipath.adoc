...
[CAUTION]
====
Version 2.3.0 and later of the connector require Bonita Studio released after October 2025. +
...
When using the connector version 2.3.0 or later, there is 2 authentication types: Client Credentials (OAuth) or Token (Bearer).
