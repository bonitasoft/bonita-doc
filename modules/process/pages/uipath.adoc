...
[CAUTION]
====
Versions 2.3.0 and later of the connector require a Bonita Studio released after October 2025. In particular, starting from 2025.1-u1. +
...
When using the connector version 2.3.0 or later, there are 2 authentication types: `Client Credentials (OAuth)` or `Token (Bearer)`. `Token` is the default authenticaiton type.
