...
[CAUTION]
====
Version 2.3.0 and upwards of the connector requires Bonita Studio released after October 2025. +
Earlier versions of Bonita Studio are not compatible with this connector versions and connector versions earlier than 2.3.0 are not compatible with former Bonita Studio releases.
====
