...
image::images-6_0/MyUser_Model_lazy.png[]

image::images-6_0/Address_Model.png[]

image::images-6_0/StudyLeave_Model.png[]

=== Connector configuration

The configuration is as follows:

image::images-6_0/document_templating_input_mappings.png[]
...
image::images-6_0/document_templating_outputs.png[]
