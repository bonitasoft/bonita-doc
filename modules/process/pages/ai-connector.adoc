...
[.text-center]
*Supported providers:* image:openai.png[OpenAI,20] OpenAI | image:anthropic.png[Anthropic,20] Anthropic | image:gemini.png[Gemini,20] Gemini | image:mistral.png[Mistral,20] Mistral | image:azure.png[Azure,20] Azure | image:ollama.png[Ollama,20] Ollama
...
|xref:ai-mistral-connector.adoc[Mistral] (`mistral-large-latest`) or xref:ai-gemini-connector.adoc[Gemini] (`gemini-2.0-flash`)
...
|xref:ai-gemini-connector.adoc[Gemini] (`gemini-2.0-flash`)
