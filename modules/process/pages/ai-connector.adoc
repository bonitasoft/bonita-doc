...
:description: The Bonita AI connectors allows for interacting with OpenAI and MistralAI chat models by sending prompt and documents and returning the generated output.
