...
:description: Bonitasoft now offers AI connectors that let you seamlessly integrate advanced language models like OpenAI, Mistral, and Ollama into your business processes.
...
* image:ollama.png[Ollama] Ollama
...
Ollama enables running large language models locally on your infrastructure without requiring API keys or cloud services. This provides several advantages:
...
* Support for any Ollama-compatible model (Llama, Mistral, DeepSeek, etc.)
* Easy model switching
* Custom model support

To get started with Ollama, install it from https://ollama.com/ and pull a model:
...
For more information on setting up and using Ollama, refer to the https://github.com/bonitasoft/bonita-connector-ai[Bonita AI Connector repository].
...
**Not required for Ollama** as it runs locally without authentication.
...
- Mistral: Official Mistral AI endpoint
- Ollama: `http://localhost:11434`
|Default to the official provider endpoint if not specified (or `http://localhost:11434` for Ollama).
...
|*chatModelName*
|false
a|The model to use for chat like `gpt-4o`, `gpt-4o-mini`, `llama3.1`, `pixtral`, ... See respective documentation for detailed information about models.
...
- Ollama: https://ollama.com/library (any Ollama-compatible model)
a|
- OpenAI: `gpt-4o`
