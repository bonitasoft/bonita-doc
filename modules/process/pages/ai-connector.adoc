...
The Bonita AI Connectors are available for **Bonita 10.2**  **Community** version and above.
...
To use a connector, add it as a dependency to your Bonita process. Choose the one related to your AI provider, we currently support OpenAI and Mistral.
