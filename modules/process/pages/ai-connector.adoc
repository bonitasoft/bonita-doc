...
* image:openai.png[OpenAI] xref:ai-openai-connector.adoc[OpenAI] -- GPT-4o and GPT models
* xref:ai-anthropic-connector.adoc[Anthropic] -- Claude models with vision support
* xref:ai-gemini-connector.adoc[Google Gemini] -- Fast and cost-effective, large context
* image:mistral.png[MistralAI] xref:ai-mistral-connector.adoc[Mistral AI] -- EU-hosted, GDPR-friendly
* xref:ai-azure-connector.adoc[Azure AI Foundry] -- Enterprise compliance with Azure AD
* xref:ai-ollama-connector.adoc[Ollama] -- Local/on-premise LLMs, no API key needed
