...
See a working example of a web service connector in this xref:ROOT:web-service-tutorial.adoc[tutorial].
...
When you configure a process that uses this connector, you must xref:ROOT:manage-dependencies.adoc[manage the configuration process dependencies].
====
