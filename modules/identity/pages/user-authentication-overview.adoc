...
The custom login page must POST a form to Bonita `/loginservice` endpoint with the following parameters:
* `username`: the username of the user to authenticate
* `password`: the password of the user to authenticate

NOTE: If the custom login page has a different origin (scheme, host and port) as Bonita webapp:
