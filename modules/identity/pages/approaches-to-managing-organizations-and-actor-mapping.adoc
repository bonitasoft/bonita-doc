...
In the Bonita Administrator Application, xref:runtime:admin-application-roles-list.adoc[define the roles and memberships] used in the actor mappings, and xref:admin-application-users-list.adoc[specify the roles of the users]. User roles are specified using a membership.
