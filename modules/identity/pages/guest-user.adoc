...
====
If you are using the UI Builder, you need to recreate the xref:{bonitaUiBuilderVersion}@ui-builder:deployment:production-packaging.adoc[UI Builder production container] to be able to use the guest user access.
====
