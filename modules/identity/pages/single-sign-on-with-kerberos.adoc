...
The recommended way to authenticate in the Bonita Runtime, in order to use the REST API, is to use the xref:api:rest-api-overview.adoc#bonita-authentication[login service]. +
