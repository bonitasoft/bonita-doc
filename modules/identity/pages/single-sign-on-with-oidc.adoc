...
1.  Check all the Bonita configuration settings are correct.
2.  Make sure `setup[.sh][.bat] push` has been executed and the server restarted after the changes.
3. Try cleaning the cache and cookies of the web browser.
--
