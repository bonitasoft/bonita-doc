...
More configuration options can be found in https://www.keycloak.org/docs/18.0/securing_apps/index.html#_java_adapter_config[Keycloak official documentation]
====
