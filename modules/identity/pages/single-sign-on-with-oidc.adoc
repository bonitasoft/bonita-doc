...
Additionally (since Bonita 2024.2-u7), you can configure the `cors-allowed-origins` property to explicitly specify which origins are allowed to make cross-origin requests:
