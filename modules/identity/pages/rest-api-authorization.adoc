...
[NOTE]
====
Default configuration and rules are available in all editions but custom configuration and rules extensibility is only available in Subscription editions.
====
...
In community edition, a set of dynamic authorization checks is predifined for the resources of the bpm, identity, portal and living APIs.
