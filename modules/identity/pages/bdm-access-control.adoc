...
. Go the _/BonitaStudioSubscription-7.7.0/workspace/tomcat/setup/platform_conf/current/tenant_portal/_ folder that has just appeared.
...
. Go to _/BonitaStudioSubscription-{bonitaVersion}/workspace/tomcat/setup/platform_conf/current/tenant_security_scripts_. Create a file _SubjectTeacherPermissionRule.groovy_, with the following content:
