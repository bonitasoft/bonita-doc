...
Only Teamwork, Efficiency, Performance and Enterprise editions can create new file of profiles, in order to create custom profiles.
...
Teamwork, Efficiency, Performance and Enterprise editions come with an .xml editor for this feature. Only Subscription editions also come with a graphical UI.
====
