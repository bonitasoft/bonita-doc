...
There are two ways to connect the Bonita Engine.
...
See the <<_bonita_properties, bonita.properties>> section to customize the configuration for your system, by editing the configuration files.
...
In Bonita, you can define a set of Custom User Information attributes. Then, each user has
...
*On-premise solution*: Configure the Bonita Tomcat bundle you have downloaded from the Ofelia Customer Service Center to activate
