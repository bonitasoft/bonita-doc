...
In development, to map entities of the organization to a profile, use the xref:ROOT:profileCreation.adoc[profile editor] in Bonita Studio. +
...
Custom profiles must be created and updated in the xref:ROOT:profileCreation.adoc[profile editor] of Bonita studio.
